...
Namespace UnitOperations
    ...
    <System.Serializable()> <ComVisible(True)> Public MustInherit Class UnitOpBaseClass
        ...
        <NonSerialized> <Xml.Serialization.XmlIgnore> Public _pp As IPropertyPackage

        Public _ppid As String = ""

        Protected _capeopenmode As Boolean = False

        Public AccumulationStream As Streams.MaterialStream
        ...
        Public Overrides Function LoadData(data As System.Collections.Generic.List(Of System.Xml.Linq.XElement)) As Boolean
            ...
            If Not ael Is Nothing Then
                AccumulationStream = New Streams.MaterialStream()
            ...
            If GetDynamicProperty("Volume") IsNot Nothing Then
                Try
                    ...
                    For Each inlet In GraphicObject.InputConnectors
                        If inlet.IsAttached And inlet.Type = ConType.ConIn Then
...
#Region "   DWSIM Specific"
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        <Xml.Serialization.XmlIgnore()> Public Overrides Property PropertyPackage() As IPropertyPackage
            Get
                ...
                Else
                    For Each pp As IPropertyPackage In Me.FlowSheet.PropertyPackages.Values
                        _ppid = pp.UniqueID
                        Return pp
                        Exit For
                    Next
                ...
                Return Nothing
            End Get
            Set(ByVal value As IPropertyPackage)
