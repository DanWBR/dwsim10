...
Imports DWSIMCore.Foundation.UnitOperations.Auxiliary.HeatExchanger
    ...
    <System.Serializable()> Public Class HeatExchanger
        ...
        Public Overrides Function LoadData(data As List(Of XElement)) As Boolean
            ...
            If Not ael Is Nothing Then
                AccumulationStreamHot = New Streams.MaterialStream()
            ...
            If Not ael2 Is Nothing Then
                AccumulationStreamCold = New Streams.MaterialStream()
        ...
        Public AccumulationStreamCold As Streams.MaterialStream

        Public AccumulationStreamHot As Streams.MaterialStream
        ...
        Public Overrides Sub Calculate(Optional ByVal args As Object = Nothing)
            ...
            Select Case CalcMode
                ...
                Case HeatExchangerCalcMode.PinchPoint
                    ...
                    Dim brt As New BrentOpt.BrentMinimize
        ...
        Public Overrides Function GetReport(su As IUnitsOfMeasure, ci As Globalization.CultureInfo, numberformat As String) As String
            ...
            str.AppendLine("    Molar composition: " & istr2.PropertyPackage.RET_VMOL(PropertyPackages.Phase.Mixture).ToArrayString())
            str.AppendLine()
