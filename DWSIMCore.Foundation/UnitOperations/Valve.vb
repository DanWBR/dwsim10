...
Namespace UnitOperations
    ...
    <System.Serializable()> Public Class Valve
                ...
                Case Else
                    ...
                    ElseIf ims.DynamicsSpec = Dynamics.DynamicsSpecType.Pressure And
                        ...
                        If CalcMode = CalculationMode.Kv_General Or CalcMode = CalculationMode.Kv_Gas Or CalcMode = CalculationMode.Kv_Liquid Then
                            ...
                            ElseIf ims.Phases(2).Properties.molarfraction = 1 Or CalcMode = CalculationMode.Kv_Gas Then
                                ims.PropertyPackage.CurrentMaterialStream = ims
                                rhog20 = ims.PropertyPackage.AUX_VAPDENS(273.15, 101325)
                                Dim roots = Quadratic.quadForm(-rhog20, rhog20 * P1 / 100000, -Ti * (519 * Kvc / (Wi * 3600)) ^ -2)
                    ...
                    With oms
                        ...
                        For Each comp In .Phases(0).Compounds.Values
                            ...
                            i += 1
                        Next
                        .SpecType = Enums.StreamSpec.Pressure_and_Enthalpy
                    End With
                    ...
                    With ims
                        ...
                        For Each comp In .Phases(0).Compounds.Values
                            ...
                            i += 1
                        Next
                        If .GraphicObject.InputConnectors(0).IsAttached Then .SpecType = Enums.StreamSpec.Pressure_and_Enthalpy
                    End With
        ...
        Public Overrides Function GetIconBitmap() As Object
            Using imgstream As IO.Stream = System.Reflection.Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.uo_valve_32.png")
