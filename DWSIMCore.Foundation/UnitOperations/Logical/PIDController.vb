...
Imports DWSIMCore.Foundation.SpecialOps.Helpers
Imports OxyPlot
...
Namespace SpecialOps
    ...
    <System.Serializable()> Public Class PIDController
        ...
        Public Overrides Function GetIconBitmap() As Object
            Using imgstream As IO.Stream = System.Reflection.Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.control_panel1.png")
        ...
        Public Overrides Sub Calculate(Optional args As Object = Nothing)
            ...
            Dim CurrentValue = SystemsOfUnits.Converter.ConvertFromSI(ControlledObjectData.Units, ControlledObject.GetPropertyValue(ControlledObjectData.PropertyName))

            Dim CurrentManipulatedValue = SystemsOfUnits.Converter.ConvertFromSI(ManipulatedObjectData.Units, ManipulatedObject.GetPropertyValue(ManipulatedObjectData.PropertyName))
