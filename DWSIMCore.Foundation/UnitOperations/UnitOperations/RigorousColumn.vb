...
Imports DWSIMCore.Foundation.UnitOperations.Auxiliary.SepOps
Imports DWSIMCore.Foundation.UnitOperations.Column
Imports OxyPlot
...
Namespace UnitOperations.Auxiliary.SepOps
    ...
    <System.Serializable()> Public Class InitialEstimates
        ...
        Public Function SaveData() As System.Collections.Generic.List(Of System.Xml.Linq.XElement) Implements ICustomXMLSerialization.SaveData
            ...
            Dim elements = XMLSerializer.Serialize(Me)
            Dim ci As Globalization.CultureInfo = Globalization.CultureInfo.InvariantCulture
...
Namespace UnitOperations
    ...
    <Serializable()> Public Class DistillationColumn
        ...
        Public Overrides Function GetIconBitmap() As Object
            Using imgstream As IO.Stream = System.Reflection.Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.col_dc_32.png")
    ...
    <Serializable()> Public Class AbsorptionColumn
        ...
        Public Overrides Function GetIconBitmap() As Object
            Using imgstream As IO.Stream = System.Reflection.Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.col_abs_32.png")
                Using bitmap = SkiaSharp.SKBitmap.Decode(imgstream)
                    Return SkiaSharp.SKImage.FromBitmap(bitmap)
                End Using
            End Using
    ...
    <System.Serializable()> Public MustInherit Class Column
        ...
        Public Overrides Function LoadData(data As System.Collections.Generic.List(Of System.Xml.Linq.XElement)) As Boolean
            ...
            If Not elm Is Nothing Then
                ...
                compids = XMLSerializer.StringToArray(elm.Element("compids").Value, ci)
        ...
        Public Overrides Function SaveData() As System.Collections.Generic.List(Of System.Xml.Linq.XElement)
            ...
            With elements
                ...
                .Item(.Count - 1).Add(New XElement("compids", XMLSerializer.ArrayToString(compids, ci)))
            ...
            For Each ms As StreamInformation In Me.MaterialStreams.Values
                Select Case ms.StreamBehavior
                    Case StreamInformation.Behavior.Feed
                        ...
                        j = 0
                        For Each comp As Compound In stream.Phases(0).Compounds.Values
