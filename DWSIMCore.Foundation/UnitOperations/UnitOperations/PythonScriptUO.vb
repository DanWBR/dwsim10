...
Namespace UnitOperations
    ...
    <System.Serializable()> Public Class CustomUO
        ...
        Public Overrides Function GetProperties(ByVal proptype As Enums.PropertyType) As String()
        ...
        Public Overrides Function GetIconBitmap() As Object
            Using imgstream As IO.Stream = System.Reflection.Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.uo_custom_32.png")
