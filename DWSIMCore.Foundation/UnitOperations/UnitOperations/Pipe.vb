...
Imports DWSIMCore.Foundation.UnitOperations.Auxiliary.Pipe
    ...
    <System.Serializable()> Public Class Pipe
        ...
        Public Overrides Sub Calculate(Optional ByVal args As Object = Nothing)
            ...
            Do
                ...
                Host.CheckAndAdd(IObj2, "", "Calculate", String.Format("External Loop #{0}", countext), "", True)
                ...
                For Each segmento In Me.Profile.Sections.Values
                    ...
                    For iq = 1 To segmento.Quantidade
                        ...
                        Host.CheckAndAdd(IObj3, "", "Calculate", String.Format("Segment #{0} ({1}/{2})", segmento.Indice, iq, segmento.Quantidade), "", True)
                        ...
                        Do
                            ...
                            Dim IObj4 As InspectorItem = Host.GetNewInspectorItem()

                            Host.CheckAndAdd(IObj4, "", "Calculate", String.Format("Increment #{0}", j + 1), "", True)
                            ...
                            Do
                                ...
                                Dim IObj5 As InspectorItem = Host.GetNewInspectorItem()

                                Host.CheckAndAdd(IObj5, "", "Calculate", String.Format("Temperature Loop #{0}", cntT), "", True)
                                ...
                                Do
                                    ...
                                    Dim IObj6 As InspectorItem = Host.GetNewInspectorItem()

                                    Host.CheckAndAdd(IObj6, "", "Calculate", String.Format("Pressure Loop #{0}", cntP), "", True)
                            ...
                            oms.SpecType = Enums.StreamSpec.Pressure_and_Enthalpy
...
#Region "        Funcoes"
        ...
        Function CalcOverallHeatTransferCoefficient(ByVal section As PipeSection, ByVal materialparede As String, ByVal EL As Double, ByVal L As Double,
            ...
            Host.CheckAndAdd(IObj, "", "CalcOverallHeatTransferCoefficient", "Overall HTC Calculation", "Overal Heat Transfer Coefficient Calculation Routine", True)
