...
Namespace UnitOperations
    ...
    <System.Serializable()> Public Class Heater
        ...
        Public Overrides Sub Calculate(Optional ByVal args As Object = Nothing)
            ...
            Select Case Me.CalcMode
                ...
                Case CalculationMode.OutletVaporFraction
                    ...
                    Else
                        tmp = Me.PropertyPackage.CalculateEquilibrium2(FlashCalculationType.PressureVaporFraction, P2, m_VFout.GetValueOrDefault, Ti * 1.2)
                    End If
                    H2 = tmp.CalculatedEnthalpy
                    CheckSpec(H2, False, "outlet enthalpy")
                    T2 = tmp.CalculatedTemperature
        ...
        Public Overrides Function GetIconBitmap() As Object
            Using imgstream As IO.Stream = System.Reflection.Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.uo_heater_32.png")
