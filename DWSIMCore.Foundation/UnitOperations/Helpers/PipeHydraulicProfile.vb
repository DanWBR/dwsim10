...
Namespace UnitOperations.Auxiliary.Pipe
    ...
    <System.Serializable()> Public Class PipeSection
        ...
        Public Sub New(ByVal indice As Integer, ByVal tipo As String, ByVal qtde As Integer, ByVal incrementos As Integer, ByVal material As String,
...
#Region "Constructors"
        ...
        Sub New(ByVal Pi As Nullable(Of Double), ByVal Ti As Nullable(Of Double), ByVal MUV As Nullable(Of Double), ByVal MUL As Nullable(Of Double),
        ByVal RHOV As Nullable(Of Double), ByVal RHOL As Nullable(Of Double), ByVal CPV As Nullable(Of Double), ByVal CPL As Nullable(Of Double),
        ByVal KV As Nullable(Of Double), ByVal KL As Nullable(Of Double), ByVal QV As Nullable(Of Double), ByVal QL As Nullable(Of Double),
        ByVal SURFT As Nullable(Of Double), ByVal DPF As Nullable(Of Double), ByVal DPH As Nullable(Of Double), ByVal EL As Nullable(Of Double),
        ByVal TIPOFLUXO As String, ByVal LIQRE As Nullable(Of Double), ByVal VAPRE As Nullable(Of Double), ByVal LIQVEL As Nullable(Of Double),
