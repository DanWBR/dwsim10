Imports System.Math
Imports DWSIMCore.Foundation.MathEx.Optimization
...
Namespace UnitOperations.Auxiliary.SepOps.SolvingMethods
    ...
    <System.Serializable()> Public Class NaphtaliSandholmMethod
        ...
        Public Function FunctionValue(ByVal xl() As Double) As Double()
            ...
            Host.CheckAndAdd(IObj, "", "FunctionValue", "Simultaneous Correction (SC) Method MESH Equations Calculator", "Naphtali-Sandholm Simultaneous Correction (SC) Method for Distillation, Absorption and Stripping", True)
            ...
            If _coltype <> Column.ColType.AbsorptionColumn And _condtype = Column.condtype.Total_Condenser Then
                sumvkj(0) = 0.0
                Vj(0) = 0.0
            End If
            ...
            For i = 1 To ns
                sumLSS += LSSj(i)
            Next
            If _coltype <> Column.ColType.AbsorptionColumn And _condtype = Column.condtype.Full_Reflux Then
                LSSj(0) = 0.0#
            ElseIf _coltype <> Column.coltype.AbsorptionColumn And _condtype = Column.condtype.Total_Condenser Then
                LSSj(0) = vc(0).Sum
        ...
        Public Function Solve(ByVal dc As Column, ByVal nc As Integer, ByVal ns As Integer, ByVal maxits As Integer,
            ...
            Host.CheckAndAdd(IObj, "", "Solve", "Simultaneous Correction (SC) Method", "Naphtali-Sandholm Simultaneous Correction (SC) Method for Distillation, Absorption and Stripping", True)
...
1,000 Btu/lbmol). If the convergence criterion is")
            ...
            If coltype = Column.ColType.DistillationColumn And condt = Column.condtype.Total_Condenser Then
            ...
            For i = 0 To ns
                Lj(i) = sumlkj(i)
                If coltype = Column.ColType.DistillationColumn And i = 0 Then
