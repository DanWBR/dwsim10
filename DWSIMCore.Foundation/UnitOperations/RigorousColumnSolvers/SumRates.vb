...
Namespace UnitOperations.Auxiliary.SepOps.SolvingMethods
    ...
    <System.Serializable()> Public Class BurninghamOttoMethod
        ...
        Public Shared Function Solve(ByVal nc As Integer, ByVal ns As Integer, ByVal maxits As Integer,
            ...
            Host.CheckAndAdd(IObj, "", "Solve", "Sum-Rates (SR) Method", "Burningham–Otto Sum-Rates (SR) Method for Absorption and Stripping", True)
            ...
            Do
                ...
                Host.CheckAndAdd(IObj2, "", "Solve", "Sum-Rates (SR) Internal Loop #" & ic, "Burningham–Otto Sum-Rates (SR) Method for Absorption and Stripping", True)
