...
Namespace UnitOperations.Auxiliary.SepOps.SolvingMethods
    ...
    <System.Serializable()> Public Class WangHenkeMethod
        ...
        Public Function Solve(ByVal rc As Column, ByVal nc As Integer, ByVal ns As Integer, ByVal maxits As Integer,
            ...
            ElseIf Not specR_OK Then
                ...
                If Not success Then
                    ...
                    Try
                        Dim br As New MathEx.BrentOpt.Brent()
        ...
        Public Function Solve_Internal(rc As Column, nc As Integer, ns As Integer, maxits As Integer,
            ...
            Host.CheckAndAdd(IObj, "", "Solve", "Bubble-Point (BP) Method", "Wang-Henke Bubble-Point (BP) Method for Distillation Columns", True)
            ...
            Do
                ...
                Host.CheckAndAdd(IObj2, "", "Solve", "Bubble-Point (BP) Internal Loop #" & ic, "Wang-Henke Bubble-Point (BP) Method for Distillation", True)
