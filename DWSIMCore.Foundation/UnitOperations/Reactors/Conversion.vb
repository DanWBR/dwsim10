    ...
    <System.Serializable()> Public Class Reactor_Conversion
        ...
        Public Overrides Sub Calculate(Optional ByVal args As Object = Nothing)
            ...
            For Each ar In Me.ReactionsSequence
                ...
                Host.CheckAndAdd(IObj2, "", "Calculate", String.Format("Reaction Sequence ID #{0}", "Reaction Names:" & ReactionsSequence.IndexOf(ar)), ar.Select(Of String)(Function(ari) FlowSheet.Reactions(ari).Name).ToArray.ToArrayString, True)
                ...
                Do
                    ...
                    If ReactorOperationMode = OperationMode.OutletTemperature Then
                        ctxt.Variables.Add("T", OutletTemperature)
                    Else
                        ctxt.Variables.Add("T", ims.Phases(0).Properties.temperature.GetValueOrDefault)
                    End If

                    Dim expr = ctxt.CompileGeneric(Of Double)(rxn.Expression)
                    X = expr.Evaluate / 100
        ...
        Public Overrides Function GetIconBitmap() As Object
            Using imgstream As IO.Stream = System.Reflection.Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.re_conv_32.png")
