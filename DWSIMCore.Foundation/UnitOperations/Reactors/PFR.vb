...
Namespace Reactors
    ...
    <System.Serializable()> Public Class Reactor_PFR
        ...
        Public Function ODEFunc(ByVal x As Double, ByVal y As Double()) As Double()
            ...
            Host.CheckAndAdd(IObj2, "", "ODEFunc", "ODE solver for reactor concentrations", "", True)
                ...
                If rxn.ReactionKinetics = ReactionKinetics.Expression Then
                    ...
                    If rxn.ReactionType = ReactionType.Kinetic Then
                        ...
                        Else
                            ...
                            ctxt.Variables.Add("T", ims.Phases(0).Properties.temperature.GetValueOrDefault)
                            ctxt.Options.ParseCulture = Globalization.CultureInfo.InvariantCulture

                            Dim expr = ctxt.CompileGeneric(Of Double)(rxn.ReactionKinFwdExpression)
                        ...
                        Else
                            ...
                            Dim expr = ctxt.CompileGeneric(Of Double)(rxn.ReactionKinRevExpression)
        ...
        Public Function Calculate_Internal(dVF As Double, Optional ByVal args As Object = Nothing) As Boolean
            ...
            Do
                ...
                Host.CheckAndAdd(IObj2, "", "Calculate", String.Format("PFR Volume Step Calculation (V = {0} m3)", currvol), "", True)
        ...
        Public Overrides Function GetIconBitmap() As Object
            Using imgstream As IO.Stream = System.Reflection.Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.re_pfr_32.png")
