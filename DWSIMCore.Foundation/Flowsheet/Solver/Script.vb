<System.Serializable()> Public Class Script
    ...
    Public Property LinkedObjectType As Enums.Scripts.ObjectType = Enums.Scripts.ObjectType.FlowsheetObject Implements IScript.LinkedObjectType
    Public Property LinkedObjectName As String = "" Implements IScript.LinkedObjectName
    Public Property LinkedEventType As Enums.Scripts.EventType = Enums.Scripts.EventType.SimulationOpened Implements IScript.LinkedEventType
    Public Property Linked As Boolean = False Implements IScript.Linked
    Public Property PythonInterpreter As Enums.Scripts.Interpreter = Enums.Scripts.Interpreter.IronPython Implements IScript.PythonInterpreter
