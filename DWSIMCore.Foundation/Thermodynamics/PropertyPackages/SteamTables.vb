...
Imports DWSIMCore.Foundation.PropertyPackages.Auxiliary
...
Namespace PropertyPackages
    ...
    <System.Serializable()> Public Class SteamTablesPropertyPackage
        ...
        Public Overrides Sub DW_CalcEquilibrium(ByVal spec1 As FlashSpec, ByVal spec2 As FlashSpec)
            ...
            Dim water As ICompound = (From subst As ICompound In Me.CurrentMaterialStream.Phases(0).Compounds.Values Select subst Where subst.ConstantProperties.CAS_Number = "7732-18-5").SingleOrDefault
...
FINAL:
        ...
        Public Overrides Function DW_CalcEnthalpy(ByVal Vx As System.Array, ByVal T As Double, ByVal P As Double, ByVal st As State) As Double
            ...
            Host.CheckAndAdd(IObj, "", "DW_CalcEnthalpy", "Steam Tables Enthalpy", "Property Package Enthalpy Calculation Routine")
            ...
            Select Case st
                ...
                Case State.Vapor
                    If T > Tbound Then
                        CurrentMaterialStream.Flowsheet.ShowMessage(String.Format("Steam Tables Enthalpy Calculation: Temperature outside valid range ({0} > {1}), extrapolating calculated values...", T, Tbound), IFlowsheet.MessageType.Warning)
                        Dim x1, x2, x3, x4, x5, p1, p2, p3, p4, p5 As Double
        ...
        Public Overrides Function DW_CalcEntropy(ByVal Vx As System.Array, ByVal T As Double, ByVal P As Double, ByVal st As State) As Double
            ...
            Select Case st
                ...
                Case State.Vapor
                    If T > Tbound Then
                        CurrentMaterialStream.Flowsheet.ShowMessage(String.Format("Steam Tables Entropy Calculation: Temperature outside valid range ({0} > {1}), extrapolating calculated values...", T, Tbound), IFlowsheet.MessageType.Warning)
                        Dim x1, x2, x3, x4, x5, p1, p2, p3, p4, p5 As Double
                        x1 = Tcrit + (Tbound - Tcrit) * 0.2
                        x2 = Tcrit + (Tbound - Tcrit) * 0.4
                        x3 = Tcrit + (Tbound - Tcrit) * 0.6
