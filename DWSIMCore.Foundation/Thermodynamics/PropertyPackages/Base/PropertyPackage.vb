...
Imports cv = DWSIMCore.Foundation.SystemsOfUnits.Converter
...
#Region "   Members"
        ...
        <JsonIgnore> <System.NonSerialized()> Private m_ms As IMaterialStream = Nothing
        ...
        <NonSerialized> Private m_ip As System.Data.DataTable
...
#Region "   Constructor"
        ...
        Public Sub LoadUserDBs()
            ...
            If Settings.UserDatabases IsNot Nothing Then
                'load user databases
                For Each fpath As String In Settings.UserDatabases
                    Try
        ...
        Public Sub CreatePhaseMappings()
            ...
            With Me._phasemappings
                ...
                If Not Settings.HideSolidPhaseFromCAPEOPENComponents Then .Add("Solid", New PhaseInfo("", 7, Phase.Solid))
            End With
        End Sub
        ...
        Public Sub CreatePhaseMappingsDW()
            ...
            With Me._phasemappings
                ...
                If Not Settings.HideSolidPhaseFromCAPEOPENComponents Then .Add("Solid", New PhaseInfo("Solid", 7, Phase.Solid))
            End With
        End Sub
...
#Region "   Properties"
        ...
        Property FlashSettings As New Dictionary(Of Enums.FlashSetting, String)
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        <XmlIgnore> <JsonIgnore> Public Property CurrentMaterialStream() As IMaterialStream Implements IPropertyPackage.CurrentMaterialStream
            Get
                Return m_ms
            End Get
            Set(ByVal MatStr As IMaterialStream)
                m_ms = Nothing
                m_ms = MatStr
...
#Region "   Must Override or Overridable Functions"
        ...
        Public Sub CalcAdditionalPhaseProperties() Implements IPropertyPackage.CalcAdditionalPhaseProperties
            ...
            Host.CheckAndAdd(IObj, "", "CalcAdditionalPhaseProperties", ComponentName & " (Additional Properties)", "Property Package Additional Phase Properties Calculation Routine")
        ...
        Public Overridable Function CalcIsothermalCompressibility(p As IPhase) As Double
            ...
            Host.CheckAndAdd(IObj, "", "CalcIsothermalCompressibility", ComponentName & " (Isothermal Compressibility)", "")
        ...
        Public Overridable Function CalcSpeedOfSound(p As IPhase) As Double
            ...
            Host.CheckAndAdd(IObj, "", "CalcSpeedOfSound", ComponentName & " (Speed of Sound)", "")
        ...
        Public Overridable Function CalcJouleThomsonCoefficient(p As IPhase) As Double
            ...
            Host.CheckAndAdd(IObj, "", "CalcJouleThomsonCoefficient", ComponentName & " (Joule-Thomson Coefficient)", "")
        ...
        Public Overridable Overloads Function DW_CalcKvalue(ByVal Vx As Double(), ByVal Vy As Double(), ByVal T As Double, ByVal P As Double, Optional ByVal type As String = "LV") As Double()
            ...
            Host.CheckAndAdd(IObj, "", "DW_CalcKvalue", ComponentName & " K-value calculation (Property Package)", "Property Package K-value Calculation Routine")
        ...
        Public Overridable Overloads Function DW_CalcKvalue(ByVal Vx As System.Array, ByVal T As Double, ByVal P As Double) As Double()
            ...
            i = 0
            For Each subst As ICompound In Me.CurrentMaterialStream.Phases(1).Compounds.Values
        ...
        Public MustOverride Function SupportsComponent(ByVal comp As ICompoundConstantProperties) As Boolean
            ...
            If Not Settings.CAPEOPENMode Then
                If Me.FlashBase.FlashSettings(Enums.FlashSetting.CalculateBubbleAndDewPoints) Then
                    Try
                        ...
                        End If
                    Catch ex As Exception
                        Me.CurrentMaterialStream.Flowsheet.ShowMessage("Bubble Temperature calculation error: " & ex.Message.ToString, IFlowsheet.MessageType.GeneralError)
                    End Try
                    Try
                        Dim Vz As Double() = Me.RET_VMOL(Phase.Mixture)
                    ...
                    Catch ex As Exception
                        Me.CurrentMaterialStream.Flowsheet.ShowMessage("Dew Temperature calculation error: " & ex.Message.ToString, IFlowsheet.MessageType.GeneralError)
                    End Try
                    Try
                        Dim Vz As Double() = Me.RET_VMOL(Phase.Mixture)
                        ...
                        End If
                    Catch ex As Exception
                        Me.CurrentMaterialStream.Flowsheet.ShowMessage("Bubble Pressure calculation error: " & ex.Message.ToString, IFlowsheet.MessageType.GeneralError)
                    End Try
                    Try
                        Dim Vz As Double() = Me.RET_VMOL(Phase.Mixture)
                    ...
                    Catch ex As Exception
                        Me.CurrentMaterialStream.Flowsheet.ShowMessage("Dew Pressure calculation error: " & ex.Message.ToString, IFlowsheet.MessageType.GeneralError)
                    End Try
                End If
            End If
        ...
        Public Overridable Sub DW_CalcLiqMixtureProps()
            ...
            For Each c As ICompound In Me.CurrentMaterialStream.Phases(1).Compounds.Values
        ...
        Public Overridable Sub DW_CalcEquilibrium(ByVal spec1 As FlashSpec, ByVal spec2 As FlashSpec)
            ...
            Host.CheckAndAdd(IObj, "", "DW_CalcEquilibrium", ComponentName & " (Phase Equilibria)", "Property Package Equilibrium Calculation Routine")
...
redirect2:                  IObj?.SetCurrent()
        ...
        Private Function EnthalpyTx(ByVal x As Double, ByVal otherargs As Object) As Double
            Dim IObj As InspectorItem = Host.GetNewInspectorItem()
            Host.CheckAndAdd(IObj, "", "EnthalpyTx", "Single-Compound Enthalpy Calculation", "Temperature Loop", True)
        ...
        Private Function EnthalpyPx(ByVal x As Double, ByVal otherargs As Object) As Double
            Dim IObj As InspectorItem = Host.GetNewInspectorItem()
            Host.CheckAndAdd(IObj, "", "EnthalpyPx", "Single-Compound Enthalpy Calculation", "Pressure Loop", True)
        ...
        Private Function EntropyTx(ByVal x As Double, ByVal otherargs As Object) As Double
            Dim IObj As InspectorItem = Host.GetNewInspectorItem()
            Host.CheckAndAdd(IObj, "", "EntropyTx", "Single-Compound Enthalpy Calculation", "Temperature Loop", True)
        ...
        Private Function EntropyPx(ByVal x As Double, ByVal otherargs As Object) As Double
            Dim IObj As InspectorItem = Host.GetNewInspectorItem()
            Host.CheckAndAdd(IObj, "", "EntropyPx", "Single-Compound Entropy Calculation", "Pressure Loop", True)
...
#Region "   Commmon Functions"
        ...
        Public Function DW_GetConstantProperties() As List(Of ICompoundConstantProperties)
        ...
        Public Sub DW_CalcCompMolarFlow(ByVal phaseID As Integer)
            ...
            If Not phaseID = -1 Then
                With Me.CurrentMaterialStream.Phases(phaseID)
                    For Each subs As ICompound In .Compounds.Values
        ...
        Public Overridable Sub DW_CalcCompFugCoeff(ByVal f As Phase)
            ...
            End Select
            Dim i As Integer = 0
            For Each subs As ICompound In Me.CurrentMaterialStream.Phases(Me.RET_PHASEID(f)).Compounds.Values
        ...
        Public Sub DW_CalcCompVolFlow(ByVal phaseID As Integer)
            ...
            For Each Subs As ICompound In CurrentMaterialStream.Phases(0).Compounds.Values
                Subs.VolumetricFraction = 0
        ...
        Public Function AUX_KHenry(ByVal CompName As String, ByVal T As Double) As Double
            ...
            Host.CheckAndAdd(IObj, "", "AUX_KHenry", "Henry's Constant Calculation", "Liquid Phase Fugacity Calculation Routine")
        ...
        Private Function AUX_Rackett_Tcm(ByVal Phase As Phase) As Double
            ...
            Dim Tc As Double
            Dim subst1, subst2 As ICompound
...
Final3:
        ...
        Public Function RET_HVAPM(ByVal Vxw As Array, ByVal T As Double) As Double
            ...
            i = 0
            For Each subst As ICompound In Me.CurrentMaterialStream.Phases(0).Compounds.Values
        ...
        Public Overridable Function AUX_LIQVISCm(ByVal T As Double, P As Double, Optional ByVal phaseid As Integer = 3) As Double
            ...
            Host.CheckAndAdd(IObj, "", "AUX_LIQVISCm", "Liquid Phase Viscosity", "Liquid Phase Viscosity Calculation Routine")
        ...
        Public Overridable Function AUX_SURFTM(ByVal T As Double) As Double
            ...
            Host.CheckAndAdd(IObj, "", "AUX_SURFTM", "Liquid Phase Surface Tension", "Liquid Phase Surface Tension Calculation Routine")
        ...
        Public Overridable Function AUX_SURFTi(ByVal constprop As ICompoundConstantProperties, ByVal T As Double) As Double
        ...
        Public Overridable Function AUX_CONDTL(ByVal T As Double, Optional ByVal phaseid As Integer = 3) As Double
            ...
            Host.CheckAndAdd(IObj, "", "AUX_CONDTL", "Liquid Phase Thermal Conductivity", "Liquid Phase Thermal Conductivity Calculation Routine")
        ...
        Public Overridable Function AUX_CONDTG(ByVal T As Double, ByVal P As Double) As Double
            ...
            Host.CheckAndAdd(IObj, "", "AUX_CONDTG", "Vapor Phase Thermal Conductivity", "Vapor Phase Thermal Conductivity Calculation Routine")
        ...
        Public Overridable Function AUX_LIQTHERMCONDi(ByVal cprop As ICompoundConstantProperties, ByVal T As Double) As Double
        ...
        Public Overridable Function AUX_VAPTHERMCONDi(ByVal cprop As ICompoundConstantProperties, ByVal T As Double, ByVal P As Double) As Double
        ...
        Public Overridable Function AUX_VAPVISCm(ByVal T As Double, ByVal RHO As Double, ByVal MM As Double) As Double
            ...
            Host.CheckAndAdd(IObj, "", "AUX_VAPVISCm", "Vapor Phase Viscosity", "Vapor Phase Viscosity Calculation Routine")
            ...
            For Each subst As ICompound In Me.CurrentMaterialStream.Phases(2).Compounds.Values
        ...
        Public Overridable Function AUX_VAPVISCi(ByVal cprop As ICompoundConstantProperties, ByVal T As Double) As Double
        ...
        Public Overridable Function AUX_SOLIDDENSi(cprop As ICompoundConstantProperties, T As Double) As Double
        ...
        Public Overridable Function AUX_SolidHeatCapacity(ByVal cprop As ICompoundConstantProperties, ByVal T As Double) As Double
        ...
        Public Function AUX_SOLIDCP(ByVal Vxm As Array, ByVal cprops As List(Of ICompoundConstantProperties), ByVal T As Double) As Double
        ...
        Public Overridable Function AUX_LIQDENS(ByVal T As Double, ByVal Vx As Array, Optional ByVal P As Double = 0, Optional ByVal Pvp As Double = 0, Optional ByVal FORCE_EOS As Boolean = False) As Double
            ...
            Host.CheckAndAdd(IObj, "", "AUX_LIQDENS", "Liquid Phase Density", "Liquid Phase Density Calculation Routine")
        ...
        Public Overridable Function AUX_LIQDENSi(ByVal subst As ICompound, ByVal T As Double) As Double
        ...
        Public Overridable Function AUX_LIQDENSi(ByVal cprop As ICompoundConstantProperties, ByVal T As Double) As Double
        ...
        Public Overridable Function AUX_LIQ_Cpi(ByVal cprop As ICompoundConstantProperties, ByVal T As Double) As Double
        ...
        Public Function AUX_DELGig_RT(ByVal T1 As Double, ByVal T2 As Double, ByVal ID() As String, ByVal stcoeff() As Double, ByVal baseID As Integer, Optional ByVal mode2 As Boolean = False) As Double Implements IPropertyPackage.AUX_DELGig_RT
        ...
        Public Overridable Function DW_CalcSolidEnthalpy(ByVal T As Double, ByVal Vx As Double(), cprops As List(Of ICompoundConstantProperties)) As Double
        ...
        Public Function CalcSolidEnthalpyFromCp(ByVal T As Double, ByVal Vx As Double(), cprops As List(Of ICompoundConstantProperties)) As Double
        ...
        Public Overridable Function DW_CalcSolidHeatCapacityCp(ByVal T As Double, ByVal Vx As Double(), cprops As List(Of ICompoundConstantProperties)) As Double
        ...
        Public Function RET_VNAMES2(order As Enums.CompoundOrdering) As String()
...
#Region "   CAPE-OPEN 1.0 Methods and Properties"
        ...
        Public Overridable Sub CalcProp(ByVal materialObject As Object, ByVal props As Object, ByVal phases As Object, ByVal calcType As String) Implements CapeOpen.ICapeThermoPropertyPackage.CalcProp
            Dim mymat As IMaterialStream = materialObject
            Me.CurrentMaterialStream = mymat
        ...
        Public Overridable Function GetComponentConstant(ByVal materialObject As Object, ByVal props As Object) As Object Implements CapeOpen.ICapeThermoPropertyPackage.GetComponentConstant
            ...
            Dim mymat As IMaterialStream = materialObject
            For Each c As ICompound In mymat.Phases(0).Compounds.Values
                For Each p As String In props
        ...
        Public Overridable Sub GetComponentList(ByRef compIds As Object, ByRef formulae As Object, ByRef names As Object, ByRef boilTemps As Object, ByRef molWt As Object, ByRef casNo As Object) Implements CapeOpen.ICapeThermoPropertyPackage.GetComponentList
            ...
            If Settings.CAPEOPENMode Then
                For Each c As ICompoundConstantProperties In _selectedcomps.Values
                    ids.Add(c.Name)
        ...
        Public Overridable Sub PropList(ByRef flashType As Object, ByRef props As Object, ByRef phases As Object, ByRef calcType As Object) Implements CapeOpen.ICapeThermoEquilibriumServer.PropList
            ...
            If Settings.HideSolidPhaseFromCAPEOPENComponents Then
...
#Region "   CAPE-OPEN 1.1 Thermo & Physical Properties"
        ...
        Public Overridable Function GetCompoundConstant(ByVal props As Object, ByVal compIds As Object) As Object Implements ICapeThermoCompounds.GetCompoundConstant
            ...
            Else
                For Each s As String In compIds
                    Dim c As ICompound = Me.CurrentMaterialStream.Phases(0).Compounds(s)
                    For Each p As String In props
                        Select Case p.ToLower
                            Case "molecularweight"
                                vals.Add(c.ConstantProperties.Molar_Weight)
        ...
        ''' Phases interface and other CAPE-OPEN  The State of Aggregation and key
        ...
        Public Overridable Sub CalcEquilibrium1(ByVal specification1 As Object, ByVal specification2 As Object, ByVal solutionType As String) Implements ICapeThermoEquilibriumRoutine.CalcEquilibrium
            ...
            If Settings.CAPEOPENMode Then
                ...
                Dim ms As IMaterialStream = Me.CurrentMaterialStream
                ...
                If Settings.HideSolidPhaseFromCAPEOPENComponents Then sok = False
                ...
                If vok Then
                    ...
                    i = 0
                    For Each s As ICompound In ms.Phases(2).Compounds.Values
                ...
                If l1ok Then
                    ...
                    i = 0
                    For Each s As ICompound In ms.Phases(3).Compounds.Values
                        vz(i) = s.MoleFraction.GetValueOrDefault
                        i += 1
                    Next
                ...
                If l2ok Then
                    ...
                    i = 0
                    For Each s As ICompound In ms.Phases(4).Compounds.Values
                        vz(i) = s.MoleFraction.GetValueOrDefault
                        i += 1
                    Next
                ...
                If sok Then
                    ...
                    i = 0
                    For Each s As ICompound In ms.Phases(7).Compounds.Values
                        vz(i) = s.MoleFraction.GetValueOrDefault
                        i += 1
                    Next
        ...
        Public Function COMaterialtoDWMaterial(ByVal material As Object) As IMaterialStream

            If TryCast(material, IMaterialStream) Is Nothing Then
        ...
        Public Sub COMaterial_GetCompositions()
            ...
            With Me.CurrentMaterialStream
                i = 0
                For Each s As ICompound In .Phases(0).Compounds.Values
                    s.MoleFraction = Vz(i)
                    i += 1
                Next
                If Vy IsNot Nothing Then
                    i = 0
                    For Each s As ICompound In .Phases(2).Compounds.Values
                        s.MoleFraction = Vy(i)
                        i += 1
                    Next
                ...
                If Vx1 IsNot Nothing Then
                    i = 0
                    For Each s As ICompound In .Phases(3).Compounds.Values
                ...
                If Vx2 IsNot Nothing Then
                    i = 0
                    For Each s As ICompound In .Phases(4).Compounds.Values
                ...
                If Vs IsNot Nothing Then
                    i = 0
                    For Each s As ICompound In .Phases(7).Compounds.Values
                        s.MoleFraction = Vs(i)
                        i += 1
                    Next
...
#Region "   CAPE-OPEN ICapeUtilities Implementation"
        ...
        Public Overridable Sub Initialize() Implements CapeOpen.ICapeUtilities.Initialize
            ...
            Me.m_ip = New System.Data.DataTable
        ...
        ''' <remarks>This interface will contain a collection of ICapeParameter 
        ...
        ''' defined CO Simulation Context </value>
        ''' <remarks>The simulation context
        ''' will be PME objects which will expose a given set of CO  Each of these interfaces will allow the
...
#End Region
        ...
        '                    DirectCast(_FlashAlgorithm, ICustomXMLSerialization).LoadData(fadata)
        '                Catch ex As Exception
        '                End Try
        ...
        '                    xdata.Element("Data").Add(DirectCast(FlashBase, ICustomXMLSerialization).SaveData())
...
#Region "   XML data persistence"
        ...
        Public Overridable Function LoadData(data As System.Collections.Generic.List(Of System.Xml.Linq.XElement)) As Boolean Implements ICustomXMLSerialization.LoadData
            ...
            If Not elf Is Nothing Then
                ...
                End If
                If Not FlashSettings.ContainsKey(Enums.FlashSetting.GibbsMinimizationExternalSolver) Then
                    FlashSettings.Add(Enums.FlashSetting.GibbsMinimizationExternalSolver, "")
                End If
                If Not FlashSettings.ContainsKey(Enums.FlashSetting.GibbsMinimizationExternalSolverConfigData) Then
                    FlashSettings.Add(Enums.FlashSetting.GibbsMinimizationExternalSolverConfigData, "")
                End If
                If Not FlashSettings.ContainsKey(Enums.FlashSetting.PHFlash_Use_Interpolated_Result_In_Oscillating_Temperature_Cases) Then
                    FlashSettings.Add(Enums.FlashSetting.PHFlash_Use_Interpolated_Result_In_Oscillating_Temperature_Cases, True)
                End If
                If Not FlashSettings.ContainsKey(Enums.FlashSetting.PVFlash_TryIdealCalcOnFailure) Then
                    FlashSettings.Add(Enums.FlashSetting.PVFlash_TryIdealCalcOnFailure, True)
                End If
            End If
...
#Region "   DWSIM IPropertyPackage implementation"
        ...
        <XmlIgnore> Public Property FlashAlgorithm As IFlashAlgorithm Implements IPropertyPackage.FlashAlgorithm
