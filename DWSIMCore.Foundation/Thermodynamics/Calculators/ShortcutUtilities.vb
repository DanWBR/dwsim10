...
Imports System.Linq
Imports DWSIMCore.Foundation.SystemsOfUnits
Imports DWSIMCore.Foundation.Streams
Imports Point = DWSIMCore.Foundation.Point
                        ...
                        With model1
                            ...
                            If DisplayEnvelopeAreas Then
                                ...
                                If results.Data("px1l1").Count > 0 Then
                                    ...
                                    Dim curve1, curve2, curve3, curve4 As New List(Of Point)
                                    For i = 0 To results.Data("px").Count - 1
                                        curve1.Add(New Point(results.Data("px")(i), results.Data("py1")(i)))
                                    Next
                                    For i = 0 To results.Data("px1l1").Count - 1
                                        curve2.Add(New Point(results.Data("px1l1")(i), results.Data("py3")(i)))
                                    Next
                                    For i = 0 To results.Data("px1l2").Count - 1
                                        curve3.Add(New Point(results.Data("px1l2")(i), results.Data("py3")(i)))
                                    Next
                                    If results.Data("pxs1").Count > 0 Then
                                        'SVLLE
                                        If results.Data("pys2").Sum > results.Data("pys1").Sum Then
                                            For i = 0 To results.Data("pxs2").Count - 1
                                                curve4.Add(New Point(results.Data("pxs2")(i), results.Data("pys2")(i)))
                                            Next
                                        Else
                                            For i = 0 To results.Data("pxs1").Count - 1
                                                curve4.Add(New Point(results.Data("pxs1")(i), results.Data("pys1")(i)))
                                            Next
                                        End If
                                    Else
                                        'VLLE
                                        For i = 0 To results.Data("px").Count - 1
                                            curve4.Add(New Point(results.Data("px")(i), results.Data("py3").Min))
                                        Next
                                    End If
                                    ...
                                    Dim iBL1, iBL2, iSL1, iSL2 As New List(Of Point)
                                    ...
                                    If iBL1.Count > 0 And iSL1.Count > 0 Then
                                        'L1
                                        Dim p1, p2 As New List(Of Point)
                                        Dim i1 = iBL1(0)
                                        Dim i2 = iSL1(0)
                                        If i1.X > i2.X Then
                                            For i = 0 To results.Data("px").Count - 1
                                                If results.Data("px")(i) <= i1.X Then
                                                    p1.Add(New Point(results.Data("px")(i), results.Data("py1")(i)))
                                                End If
                                            Next
                                            ...
                                            Next
                                            For i = 0 To results.Data("px1l1").Count - 1
                                                p2.Add(New Point(results.Data("px1l1")(i), results.Data("py3")(i)))
                                            Next
                                            p1.Add(i1)
                                            p2.Add(i1)
                                        Else
                                            ...
                                            Next
                                            For i = 0 To results.Data("px1l1").Count - 1
                                                p1.Add(New Point(results.Data("px1l1")(i), results.Data("py3")(i)))
                                            Next
                                            For i = 0 To curve4.Count - 1
                                                If curve4(i).X <= i2.X Then
                                                    p2.Add(curve4(i))
                                    ...
                                    If iBL2.Count > 0 And iSL2.Count > 0 Then
                                        ...
                                        If i1.X < i2.X Then
                                            ...
                                            Next
                                            For i = 0 To results.Data("px1l2").Count - 1
                                                p2.Add(New Point(results.Data("px1l2")(i), results.Data("py3")(i)))
                                            Next
                                            For i = 0 To curve4.Count - 1
                                                If curve4(i).X >= i2.X Then
                                                    p2.Add(curve4(i))
                                        ...
                                        Else
                                            For i = 0 To results.Data("px1l2").Count - 1
                                                p1.Add(New Point(results.Data("px1l2")(i), results.Data("py3")(i)))
                                            Next
                                            For i = 0 To results.Data("px").Count - 1
                                                If results.Data("px")(i) >= i1.X Then
                                                    p1.Add(New Point(results.Data("px")(i), results.Data("py1")(i)))
