...
Namespace PropertyPackages.Auxiliary.FlashAlgorithms
    ...
    <System.Serializable()> Public Class BostonBrittInsideOut
        ...
        Public Overrides ReadOnly Property AlgoType As Enums.FlashMethod
            Get
                Return Enums.FlashMethod.Inside_Out_VLE
            End Get
        End Property
        ...
        Public Overrides Function Flash_PT(ByVal Vz As Double(), ByVal P As Double, ByVal T As Double, ByVal PP As PropertyPackages.PropertyPackage, Optional ByVal ReuseKI As Boolean = False, Optional ByVal PrevKi As Double() = Nothing) As Object
            ...
            fastmode = Me.FlashSettings(Enums.FlashSetting.IO_FastMode)
            ...
            Do
                ...
                If Double.IsNaN(V) Then Throw New Exception(("PropPack_FlashTPVapFracError"))
                If ecount > maxit_e Then Throw New Exception(("PropPack_FlashMaxIt2"))
            ...
            WriteDebugInfo("PT Flash [IO]: Converged in " & ecount & " iterations. Time taken: " & dt.TotalMilliseconds & " ms. Error function value: " & AbsSumY(fx))
...
out:        Return New Object() {L, V, Vx, Vy, ecount, 0.0#, Vx, 0.0#, PP.RET_NullVector}
        ...
        Public Overrides Function Flash_PH(ByVal Vz As Double(), ByVal P As Double, ByVal H As Double, ByVal Tref As Double, ByVal PP As PropertyPackages.PropertyPackage, Optional ByVal ReuseKI As Boolean = False, Optional ByVal PrevKi As Double() = Nothing) As Object
            ...
            maxit_i = Me.FlashSettings(Enums.FlashSetting.PHFlash_Maximum_Number_Of_Internal_Iterations)
            maxit_e = Me.FlashSettings(Enums.FlashSetting.PHFlash_Maximum_Number_Of_External_Iterations)
            itol = Me.FlashSettings(Enums.FlashSetting.PHFlash_Internal_Loop_Tolerance).ToDoubleFromInvariant
            etol = Me.FlashSettings(Enums.FlashSetting.PHFlash_External_Loop_Tolerance).ToDoubleFromInvariant
...
restart:    Do
                ...
                If Me.FlashSettings(Enums.FlashSetting.IO_FastMode) = False Then
                ...
                If Double.IsNaN(AbsSumY(fx)) Then Throw New Exception(("PropPack_FlashError"))
            ...
            WriteDebugInfo("PH Flash [IO]: Converged in " & ecount & " iterations. Time taken: " & dt.TotalMilliseconds & " ms. Error function value: " & AbsSumY(fx))
...
restart:    Do
            ...
            WriteDebugInfo("PS Flash [IO]: Converged in " & ecount & " iterations. Time taken: " & dt.TotalMilliseconds & " ms. Error function value: " & AbsSumY(fx))
        ...
        Public Overrides Function Flash_PV(ByVal Vz As Double(), ByVal P As Double, ByVal V As Double, ByVal Tref As Double, ByVal PP As PropertyPackages.PropertyPackage, Optional ByVal ReuseKI As Boolean = False, Optional ByVal PrevKi As Double() = Nothing) As Object
            ...
            Do
                ...
                err = 0
                If Me.FlashSettings(Enums.FlashSetting.IO_FastMode) = False Then err = bo2.brentoptimize(0, 2, 0.0001, alpha)
                ...
                If ecount > maxit_e Then
                    Throw New Exception(("PropPack_FlashMaxIt"))
                End If
                If Double.IsNaN(AbsSumY(fx)) Then
                    Throw New Exception(("PropPack_FlashError"))
                End If
            ...
            Loop Until AbsSumy(fx) < etol * (n + 2)
...
final:      d2 = Date.Now
            ...
            WriteDebugInfo("PV Flash [IO]: Converged in " & ecount & " iterations. Time taken: " & dt.TotalMilliseconds & " ms. Error function value: " & AbsSumY(fx))
...
final:      d2 = Date.Now
            ...
            WriteDebugInfo("TV Flash [IO]: Converged in " & ecount & " iterations. Time taken: " & dt.TotalMilliseconds & " ms. Error function value: " & AbsSumY(fx))
