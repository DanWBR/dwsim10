    ...
    <System.Serializable()> Public Class NestedLoopsSLE
        ...
        Public Overrides ReadOnly Property AlgoType As Enums.FlashMethod
            Get
                If SolidSolution Then
                    Return Enums.FlashMethod.Nested_Loops_SLE_SolidSolution
                Else
                    Return Enums.FlashMethod.Nested_Loops_SLE_Eutectic
                End If
            End Get
        End Property
        ...
        Public Function Flash_PT_SS(ByVal Vz As Double(), ByVal P As Double, ByVal T As Double, ByVal PP As PropertyPackages.PropertyPackage, Optional ByVal ReuseKI As Boolean = False, Optional ByVal PrevKi As Double() = Nothing) As Object
            ...
            Do
                ...
                If Double.IsNaN(L) Then Throw New Exception(("PropPack_FlashTPVapFracError"))
...
out:        Return New Object() {L, V, Vx, Vy, ecount, 0.0#, PP.RET_NullVector, S, Vs}
        ...
        Function Flash_SL(ByVal Vz As Double(), ByVal P As Double, ByVal T As Double, ByVal PP As PropertyPackages.PropertyPackage) As Object
            ...
            Host.CheckAndAdd(IObj, "", "Flash_SL", Name & " (SLE Flash)", "Pressure-Temperature Solid-Liquid Flash Algorithm Routine", True)
            ...
            Dim Vn(n) As String
            Dim constprop As ICompoundConstantProperties
...
out:        d2 = Date.Now
        ...
        Public Function Flash_PT_NL(ByVal Vz0 As Double(), ByVal P As Double, ByVal T As Double, ByVal PP As PropertyPackages.PropertyPackage, Optional ByVal ReuseKI As Boolean = False, Optional ByVal PrevKi As Double() = Nothing) As Object
            ...
            Do
                ...
                Host.CheckAndAdd(IObj2, "", "Flash_PT", "PT SVLE Internal Loop Iteration", "Pressure-Temperature Flash Algorithm Convergence Iteration Step", True)
                ...
                Do
                    ...
                    Host.CheckAndAdd(IObj3, "", "Flash_PT", "PT Flash VLE Newton Iteration", "Pressure-Temperature Flash Algorithm Convergence Iteration Step")
...
out:            'calculate global phase fractions
                ...
                If gcount > maxit_e Then Throw New Exception(("PropPack_FlashMaxIt2"))
