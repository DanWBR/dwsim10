...
Namespace PropertyPackages.Auxiliary.FlashAlgorithms
    ...
    Public Class NestedLoopsSVLLE
        ...
        Public Overrides ReadOnly Property AlgoType As Enums.FlashMethod
            Get
                Return Enums.FlashMethod.Nested_Loops_SVLLE
            End Get
        End Property
        ...
        Public Overrides Function Flash_PV(Vz() As Double, P As Double, V As Double, Tref As Double, PP As PropertyPackage, Optional ReuseKI As Boolean = False, Optional PrevKi() As Double = Nothing) As Object
            ...
            If PP.ForcedSolids.Count > 0 Then
                ...
                PP.Flowsheet?.ShowMessage("Warning: when compounds are marked as forced solids, partial or full vaporization calculations are done solids-free. Specified and calculated vapor fractions won't match.", IFlowsheet.MessageType.Warning)
