...
Namespace PropertyPackages.Auxiliary.FlashAlgorithms
    ...
    <System.Serializable()> Public Class SimpleLLE
        ...
        Public Overrides ReadOnly Property AlgoType As Enums.FlashMethod
            Get
                Return Enums.FlashMethod.Simple_LLE
            End Get
        End Property
        ...
        Public Overrides Function Flash_PT(ByVal Vz As Double(), ByVal P As Double, ByVal T As Double, ByVal PP As PropertyPackages.PropertyPackage, Optional ByVal ReuseKI As Boolean = False, Optional ByVal PrevKi As Double() = Nothing) As Object
            ...
            Do
                ...
                Host.CheckAndAdd(IObj2, "", "Flash_PT", "LLE-Flash Newton Iteration #" & ecount + 1, "Constant-Temperature LLE Flash Algorithm Convergence Iteration Step")
                ...
                If Double.IsNaN(err) Then Throw New Exception("PropPack_FlashError")
                ...
                If ecount > 10000 Then Throw New Exception("PropPack_FlashMaxIt")
