...
Imports System.Math
Imports DWSIMCore.Foundation.Enums.FlashSetting
...
Namespace PropertyPackages.Auxiliary.FlashAlgorithms
    ...
    <System.Serializable()> Public MustInherit Class FlashAlgorithm
        ...
        Implements IFlashAlgorithm, ICustomXMLSerialization

        Public Property Order As Integer = 1000 Implements IFlashAlgorithm.Order

        Public Property FlashSettings As New Dictionary(Of Enums.FlashSetting, String) Implements IFlashAlgorithm.FlashSettings
        ...
        Public Shared Function GetDefaultSettings() As Dictionary(Of Enums.FlashSetting, String)

            Dim settings As New Dictionary(Of Enums.FlashSetting, String)

            settings(Enums.FlashSetting.Replace_PTFlash) = False
            settings(Enums.FlashSetting.ValidateEquilibriumCalc) = False
            settings(Enums.FlashSetting.UsePhaseIdentificationAlgorithm) = False
            settings(Enums.FlashSetting.CalculateBubbleAndDewPoints) = False

            settings(Enums.FlashSetting.ValidationGibbsTolerance) = "0.01"

            settings(Enums.FlashSetting.PHFlash_Maximum_Number_Of_External_Iterations) = "100"
            settings(Enums.FlashSetting.PHFlash_External_Loop_Tolerance) = "0.0001"
            settings(Enums.FlashSetting.PHFlash_Maximum_Number_Of_Internal_Iterations) = "100"
            settings(Enums.FlashSetting.PHFlash_Internal_Loop_Tolerance) = "0.0001"
            settings(Enums.FlashSetting.PTFlash_Maximum_Number_Of_External_Iterations) = "100"
            settings(Enums.FlashSetting.PTFlash_External_Loop_Tolerance) = "0.0001"
            settings(Enums.FlashSetting.PTFlash_Maximum_Number_Of_Internal_Iterations) = "100"
            settings(Enums.FlashSetting.PTFlash_Internal_Loop_Tolerance) = "0.0001"

            settings(Enums.FlashSetting.NL_FastMode) = True

            settings(Enums.FlashSetting.IO_FastMode) = True

            settings(Enums.FlashSetting.GM_OptimizationMethod) = "IPOPT"

            settings(Enums.FlashSetting.ThreePhaseFlashStabTestSeverity) = "0"

            settings(Enums.FlashSetting.ThreePhaseFlashStabTestCompIds) = ""

            settings(Enums.FlashSetting.PVFlash_FixedDampingFactor) = "1.0"
            settings(Enums.FlashSetting.PVFlash_MaximumTemperatureChange) = "10.0"
            settings(Enums.FlashSetting.PVFlash_TemperatureDerivativeEpsilon) = "0.1"

            settings(Enums.FlashSetting.ST_Number_of_Random_Tries) = "20"

            settings(Enums.FlashSetting.CheckIncipientLiquidForStability) = False

            settings(Enums.FlashSetting.PHFlash_MaximumTemperatureChange) = "30.0"

            settings(Enums.FlashSetting.PTFlash_DampingFactor) = "1.0"

            settings(Enums.FlashSetting.ForceEquilibriumCalculationType) = "Default"

            settings(Enums.FlashSetting.ImmiscibleWaterOption) = False

            settings(Enums.FlashSetting.HandleSolidsInDefaultEqCalcMode) = False

            settings(Enums.FlashSetting.UseIOFlash) = False

            settings(Enums.FlashSetting.GibbsMinimizationExternalSolver) = ""

            settings(Enums.FlashSetting.GibbsMinimizationExternalSolverConfigData) = ""

            settings(Enums.FlashSetting.PHFlash_Use_Interpolated_Result_In_Oscillating_Temperature_Cases) = False

            settings(Enums.FlashSetting.PVFlash_TryIdealCalcOnFailure) = True
        ...
        Public Function CalculateEquilibrium(spec1 As FlashSpec, spec2 As FlashSpec,
            ...
            Dim constprops As List(Of ICompoundConstantProperties) = pp.DW_GetConstantProperties()
...
#Region "Generic Functions"
        ...
        Public Overridable Function Flash_PSF(ByVal Vz As Double(), ByVal P As Double, ByVal V As Double, ByVal Tref As Double, ByVal PP As PropertyPackages.PropertyPackage, Optional ByVal ReuseKI As Boolean = False, Optional ByVal PrevKi As Double() = Nothing) As Object
            Throw New Exception("PropPack_FlashPSFError")
            Return Nothing
        End Function

        Public MustOverride Function Flash_PT(ByVal Vz As Double(), ByVal P As Double, ByVal T As Double, ByVal PP As PropertyPackages.PropertyPackage, Optional ByVal ReuseKI As Boolean = False, Optional ByVal PrevKi As Double() = Nothing) As Object Implements IFlashAlgorithm.Flash_PT

        Public MustOverride Function Flash_PH(ByVal Vz As Double(), ByVal P As Double, ByVal H As Double, ByVal Tref As Double, ByVal PP As PropertyPackages.PropertyPackage, Optional ByVal ReuseKI As Boolean = False, Optional ByVal PrevKi As Double() = Nothing) As Object Implements IFlashAlgorithm.Flash_PH

        Public MustOverride Function Flash_PS(ByVal Vz As Double(), ByVal P As Double, ByVal S As Double, ByVal Tref As Double, ByVal PP As PropertyPackages.PropertyPackage, Optional ByVal ReuseKI As Boolean = False, Optional ByVal PrevKi As Double() = Nothing) As Object Implements IFlashAlgorithm.Flash_PS

        Public MustOverride Function Flash_PV(ByVal Vz As Double(), ByVal P As Double, ByVal V As Double, ByVal Tref As Double, ByVal PP As PropertyPackages.PropertyPackage, Optional ByVal ReuseKI As Boolean = False, Optional ByVal PrevKi As Double() = Nothing) As Object Implements IFlashAlgorithm.Flash_PV

        Public MustOverride Function Flash_TV(ByVal Vz As Double(), ByVal T As Double, ByVal V As Double, ByVal Pref As Double, ByVal PP As PropertyPackages.PropertyPackage, Optional ByVal ReuseKI As Boolean = False, Optional ByVal PrevKi As Double() = Nothing) As Object Implements IFlashAlgorithm.Flash_TV
        ...
        Public Function Flash_VT(ByVal Vz As Double(), ByVal Vspec As Double, ByVal T As Double, ByVal Pref As Double, ByVal PP As PropertyPackages.PropertyPackage, Optional ByVal ReuseKI As Boolean = False, Optional ByVal PrevKi As Double() = Nothing) As FlashCalculationResult
            ...
            simplex.ComputeMin(Function(Pvec)
                                   ...
                                   RHOV = PP.AUX_Z(flashresult.GetVaporPhaseMoleFractions, T, P, Enums.PhaseName.Vapor) * 8.314 * T / P 'mol/m3
                                   RHOV = 1 / RHOV 'kmol/m3
...
#Region "Liquid Phase Stability Check"
        ...
        Public Function StabTest(ByVal T As Double, ByVal P As Double, ByVal Vz As Double(), ByVal VTc As Double(), ByVal pp As PropertyPackage)
            ...
            Host.CheckAndAdd(IObj, "", "StabTest", Name & " (Stability Test)", "Liquid Phase Stability Test Routine", True)
...
will converge to this solution.")
            ...
            Dim prevstatus = Settings.InspectorEnabled
            ...
            Settings.InspectorEnabled = prevstatus
...
#Region "Phases and Compounds Heuristics Check"
        ...
        Public Function PerformHeuristicsTest(Vz As Double(), T As Double, P As Double, pp As PropertyPackage) As HeuristicsTestResult
            ...
            Dim FlashType As String = FlashSettings(Enums.FlashSetting.ForceEquilibriumCalculationType)
            Dim HandleSolids As Boolean = FlashSettings(Enums.FlashSetting.HandleSolidsInDefaultEqCalcMode)

            If FlashType = "Default" And hres.SolidPhase And Not HandleSolids And pp.ForcedSolids.Count = 0 Then
                'pp.Flowsheet.ShowMessage(String.Format(pp.Flowsheet.GetTranslatedString("FoundSolidsWarning") + " (P = {0:N2} Pa, T = {1:N2} K)", P, T), IFlowsheet.MessageType.Warning)
...
#Region "XML Serialization"
        ...
        Public Overridable Function LoadData(data As List(Of XElement)) As Boolean Implements ICustomXMLSerialization.LoadData
            ...
            If Not el Is Nothing Then
                ...
                If Not FlashSettings.ContainsKey(Enums.FlashSetting.PVFlash_FixedDampingFactor) Then
                    FlashSettings.Add(Enums.FlashSetting.PVFlash_FixedDampingFactor, 1.0.ToString(Globalization.CultureInfo.InvariantCulture))
                End If
                If Not FlashSettings.ContainsKey(Enums.FlashSetting.PVFlash_MaximumTemperatureChange) Then
                    FlashSettings.Add(Enums.FlashSetting.PVFlash_MaximumTemperatureChange, 10.0.ToString(Globalization.CultureInfo.InvariantCulture))
                End If
                If Not FlashSettings.ContainsKey(Enums.FlashSetting.PVFlash_TemperatureDerivativeEpsilon) Then
                    FlashSettings.Add(Enums.FlashSetting.PVFlash_TemperatureDerivativeEpsilon, 0.1.ToString(Globalization.CultureInfo.InvariantCulture))
                End If
                If Not FlashSettings.ContainsKey(Enums.FlashSetting.ST_Number_of_Random_Tries) Then
                    FlashSettings.Add(Enums.FlashSetting.ST_Number_of_Random_Tries, 20)
                End If
                If Not FlashSettings.ContainsKey(Enums.FlashSetting.CheckIncipientLiquidForStability) Then
                    FlashSettings.Add(Enums.FlashSetting.CheckIncipientLiquidForStability, False)
                End If
                If Not FlashSettings.ContainsKey(Enums.FlashSetting.PHFlash_MaximumTemperatureChange) Then
                    FlashSettings.Add(Enums.FlashSetting.PHFlash_MaximumTemperatureChange, 30.0.ToString(Globalization.CultureInfo.InvariantCulture))
                End If
                If Not FlashSettings.ContainsKey(Enums.FlashSetting.PTFlash_DampingFactor) Then
                    FlashSettings.Add(Enums.FlashSetting.PTFlash_DampingFactor, 1.0.ToString(Globalization.CultureInfo.InvariantCulture))
                End If
                If Not FlashSettings.ContainsKey(Enums.FlashSetting.ForceEquilibriumCalculationType) Then
                    FlashSettings.Add(Enums.FlashSetting.ForceEquilibriumCalculationType, "Default")
                End If
                If Not FlashSettings.ContainsKey(Enums.FlashSetting.ImmiscibleWaterOption) Then
                    FlashSettings.Add(Enums.FlashSetting.ImmiscibleWaterOption, False)
                End If
                If Not FlashSettings.ContainsKey(Enums.FlashSetting.HandleSolidsInDefaultEqCalcMode) Then
                    FlashSettings.Add(Enums.FlashSetting.HandleSolidsInDefaultEqCalcMode, False)
                End If
                If Not FlashSettings.ContainsKey(Enums.FlashSetting.UseIOFlash) Then
                    FlashSettings.Add(Enums.FlashSetting.UseIOFlash, False)
                End If
            End If
        ...
        Public Overridable Function SaveData() As List(Of XElement) Implements ICustomXMLSerialization.SaveData
...
#End Region
        ...
        Public Function Clone() As IFlashAlgorithm Implements IFlashAlgorithm.Clone

            Dim clonedobj As FlashAlgorithm = Me.MemberwiseClone()
            clonedobj.FlashSettings = New Dictionary(Of Enums.FlashSetting, String)
        ...
        Public MustOverride ReadOnly Property AlgoType As Enums.FlashMethod Implements IFlashAlgorithm.AlgoType

        Public MustOverride ReadOnly Property Description As String Implements IFlashAlgorithm.Description

        Public MustOverride ReadOnly Property Name As String Implements IFlashAlgorithm.Name

        Public Overridable ReadOnly Property InternalUseOnly As Boolean Implements IFlashAlgorithm.InternalUseOnly
            Get
                Return False
            End Get
        End Property

        Public Property Tag As String = "" Implements IFlashAlgorithm.Tag

        Public MustOverride ReadOnly Property MobileCompatible As Boolean Implements IFlashAlgorithm.MobileCompatible
    ...
    <System.Serializable> Public Class FlashCalculationResult
        ...
        Implements IFlashCalculationResult
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Property BaseMoleAmount As Double = 1.0# Implements IFlashCalculationResult.BaseMoleAmount
        Public Property Kvalues As New List(Of Double) Implements IFlashCalculationResult.Kvalues
        Public Property MixtureMoleAmounts As New List(Of Double) Implements IFlashCalculationResult.MixtureMoleAmounts
        Public Property VaporPhaseMoleAmounts As New List(Of Double) Implements IFlashCalculationResult.VaporPhaseMoleAmounts
        Public Property LiquidPhase1MoleAmounts As New List(Of Double) Implements IFlashCalculationResult.LiquidPhase1MoleAmounts
        Public Property LiquidPhase2MoleAmounts As New List(Of Double) Implements IFlashCalculationResult.LiquidPhase2MoleAmounts
        Public Property SolidPhaseMoleAmounts As New List(Of Double) Implements IFlashCalculationResult.SolidPhaseMoleAmounts
        Public Property CalculatedTemperature As Nullable(Of Double) Implements IFlashCalculationResult.CalculatedTemperature
        Public Property CalculatedPressure As Nullable(Of Double) Implements IFlashCalculationResult.CalculatedPressure
        Public Property CalculatedEnthalpy As Nullable(Of Double) Implements IFlashCalculationResult.CalculatedEnthalpy
        Public Property CalculatedEntropy As Nullable(Of Double) Implements IFlashCalculationResult.CalculatedEntropy
        Public Property CompoundProperties As List(Of ICompoundConstantProperties) Implements IFlashCalculationResult.CompoundProperties
        Public Property FlashAlgorithmType As String = "" Implements IFlashCalculationResult.FlashAlgorithmType
        ...
        Public Property ResultException As Exception Implements IFlashCalculationResult.ResultException
        Public Property IterationsTaken As Integer = 0 Implements IFlashCalculationResult.IterationsTaken
        Public Property TimeTaken As New TimeSpan() Implements IFlashCalculationResult.TimeTaken

        Sub New()

        End Sub

        Sub New(constprop As List(Of ICompoundConstantProperties))

            CompoundProperties = constprop

        End Sub

        Public Function GetVaporPhaseMoleFractions() As Double() Implements IFlashCalculationResult.GetVaporPhaseMoleFractions
        ...
        Public Function GetLiquidPhase1MoleFractions() As Double() Implements IFlashCalculationResult.GetLiquidPhase1MoleFractions
        ...
        Public Function GetLiquidPhase2MoleFractions() As Double() Implements IFlashCalculationResult.GetLiquidPhase2MoleFractions
        ...
        Public Function GetSolidPhaseMoleFractions() As Double() Implements IFlashCalculationResult.GetSolidPhaseMoleFractions
        ...
        Public Function GetVaporPhaseMoleFraction() As Double Implements IFlashCalculationResult.GetVaporPhaseMoleFraction
        ...
        Public Function GetLiquidPhase1MoleFraction() As Double Implements IFlashCalculationResult.GetLiquidPhase1MoleFraction
        ...
        Public Function GetLiquidPhase2MoleFraction() As Double Implements IFlashCalculationResult.GetLiquidPhase2MoleFraction
        ...
        Public Function GetSolidPhaseMoleFraction() As Double Implements IFlashCalculationResult.GetSolidPhaseMoleFraction
        ...
        Public Function GetVaporPhaseMassFractions() As Double() Implements IFlashCalculationResult.GetVaporPhaseMassFractions

            Return ConvertToMassFractions(GetVaporPhaseMoleFractions())

        End Function

        Public Function GetLiquidPhase1MassFractions() As Double() Implements IFlashCalculationResult.GetLiquidPhase1MassFractions

            Return ConvertToMassFractions(GetLiquidPhase1MoleFractions())

        End Function

        Public Function GetLiquidPhase2MassFractions() As Double() Implements IFlashCalculationResult.GetLiquidPhase2MassFractions

            Return ConvertToMassFractions(GetLiquidPhase2MoleFractions())

        End Function

        Public Function GetSolidPhaseMassFractions() As Double() Implements IFlashCalculationResult.GetSolidPhaseMassFractions

            Return ConvertToMassFractions(GetSolidPhaseMoleFractions())

        End Function

        Private Function ConvertToMassFractions(ByVal Vz As Double()) As Double() Implements IFlashCalculationResult.ConvertToMassFractions

            Dim Vwe(Vz.Length - 1) As Double
            Dim mol_x_mm As Double = 0
            Dim i As Integer = 0
            For Each sub1 As ICompoundConstantProperties In CompoundProperties
        ...
        Private Function CalcMolarWeight(ByVal Vz() As Double) As Double Implements IFlashCalculationResult.CalcMolarWeight

            Dim val As Double

            Dim i As Integer = 0

            For Each subst As ICompoundConstantProperties In CompoundProperties
        ...
        Public Function GetVaporPhaseMassFraction() As Double Implements IFlashCalculationResult.GetVaporPhaseMassFraction
        ...
        Public Function GetLiquidPhase1MassFraction() As Double Implements IFlashCalculationResult.GetLiquidPhase1MassFraction
        ...
        Public Function GetLiquidPhase2MassFraction() As Double Implements IFlashCalculationResult.GetLiquidPhase2MassFraction
        ...
        Public Function GetSolidPhaseMassFraction() As Double Implements IFlashCalculationResult.GetSolidPhaseMassFraction
