...
Namespace PropertyPackages.Auxiliary
    ...
    <System.Serializable()> Public Class Unifac
        ...
        Function GAMMA_MR(ByVal T As Double, ByVal Vx As Double(), ByVal VQ As Double(), ByVal VR As Double(), ByVal VEKI As List(Of Dictionary(Of Integer, Double))) As Double()
            ...
            Host.CheckAndAdd(IObj, "", "GAMMA_MR", "UNIFAC Activity Coefficient", "UNIFAC Activity Coefficient Calculation Routine")
    ...
    <System.Serializable()> Public Class UnifacGroups
        ...
        Sub New(ll As Boolean)
            ...
            Using filestr As IO.Stream = System.Reflection.Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.unifac.txt")
            ...
            Using filestr As IO.Stream = System.Reflection.Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.unifac_ip.txt")
                Using parser As New TextFieldParser(filestr)
                    delimiter = vbTab
                    parser.SetDelimiters(delimiter)
                    fields = parser.ReadFields()
            ...
            If ll Then
                ...
                Using filestr As IO.Stream = System.Reflection.Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.unifac_ll_ip.txt")
                    Using parser As New TextFieldParser(filestr)
                        delimiter = ","
                        parser.SetDelimiters(delimiter)
                        While Not parser.EndOfData
