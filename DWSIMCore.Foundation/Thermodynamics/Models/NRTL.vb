...
Namespace PropertyPackages.Auxiliary
    ...
    <System.Serializable()> Public Class NRTL
        ...
        Sub New()
            ...
            Using filestr As IO.Stream = System.Reflection.Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.nrtl.dat")
            ...
            Using filestr As IO.Stream = System.Reflection.Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.biod_intparm_nrtl.dat")
                Using t As New IO.StreamReader(filestr)
                    nrtlipc = fh1.ReadStream(t)
                End Using
            End Using
        ...
        Function GAMMA_MR(ByVal T As Double, ByVal Vx As Double(), ByVal Vids As String()) As Double()
            ...
            Host.CheckAndAdd(IObj, "", "GAMMA_MR", "NRTL Activity Coefficient", "Non-Random-Two-Liquid Activity Coefficient Calculation Routine")
