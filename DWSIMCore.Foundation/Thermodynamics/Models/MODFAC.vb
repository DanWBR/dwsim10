...
Namespace PropertyPackages.Auxiliary
    ...
    <System.Serializable()> Public Class Modfac
        ...
        Function GAMMA_MR(ByVal T As Double, ByVal Vx As Double(), ByVal VQ As Double(), ByVal VR As Double(), ByVal VEKI As List(Of Dictionary(Of Integer, Double))) As Double()
            ...
            Host.CheckAndAdd(IObj, "", "GAMMA_MR", "Modified UNIFAC (Dortmund) Activity Coefficient", "MODFAC-Do Activity Coefficient Calculation Routine")
    ...
    <System.Serializable()> Public Class ModfacGroups
        ...
        Sub New()
            ...
            Using filestr As IO.Stream = System.Reflection.Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.modfac.txt")
            ...
            Using filestr As IO.Stream = System.Reflection.Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.modfac_ip.txt")
                Using parser As New TextFieldParser(filestr)
                    delimiter = " "
                    parser.SetDelimiters(delimiter)
                    fields = parser.ReadFields()
