...
Namespace Databases
    ...
    <System.Serializable()> Public Class ChemSep
        ...
        Sub New()
            ...
            With fh1
                ...
                Using filestr As Stream = Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.csid.dat")
        ...
        Public Sub Load()
            ...
            Using filestr As Stream = Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.chemsep1.xml")
                Using t As New StreamReader(filestr)
                    mytxt = t.ReadToEnd()
                End Using
            End Using
            ...
            Using filestr As Stream = Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.chemsep2.xml")
                Using t As New StreamReader(filestr)
                    mytxt = t.ReadToEnd()
                End Using
            End Using
        ...
        Public Function Transfer(Optional ByVal CompName As String = "") As ConstantProperties()
        ...
        Private Function GetComps(xmldoc As XmlDocument, Optional ByVal CompName As String = "") As List(Of ConstantProperties)
    ...
    <System.Serializable()> Public Class DWSIM
        ...
        Public Sub Load()
            ...
            Using filestr As Stream = Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.dwsim.xml")
    ...
    Public Class Biodiesel
        ...
        Public Sub Load()
            ...
            Using filestr As Stream = Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.biod_db.xml")
                reader = XmlReader.Create(filestr)
                reader.Read()
                xmldoc = New XmlDocument
                xmldoc.Load(reader)
    ...
    <System.Serializable()> Public Class UserDB
        ...
        Public Shared Sub AddCompounds(ByVal comps() As ICompoundConstantProperties, xmlstream As Stream, ByVal replace As Boolean)
            ...
            Using reader = XmlReader.Create(xmlstream)
                ...
                For Each comp As ConstantProperties In comps
        ...
        Public Shared Function ReadComps(ByVal input As Stream) As ConstantProperties()
        ...
        Public Shared Function ReadComps(ByVal xmlpath As String) As ConstantProperties()
        ...
        Public Shared Function ReadComps(reader As XmlReader) As ConstantProperties()
    ...
    <System.Serializable()> Public Class UserIPDB
        ...
        Public Shared Sub AddInteractionParameters(ByVal IPDS() As InteractionParameter, xmlstream As MemoryStream, ByVal replace As Boolean)
            ...
            Using reader = XmlReader.Create(xmlstream)
                ...
                For Each IP As InteractionParameter In IPDS
                    Dim index As Integer = -1
                    Dim i As Integer = 0
        ...
        Public Shared Function ReadInteractions(ByVal xmlpath As String, ByVal Model As String) As InteractionParameter()
            ...
            Dim IP As InteractionParameter
            Dim IPA As New List(Of InteractionParameter)
            Dim cult As Globalization.CultureInfo = New Globalization.CultureInfo("en-US")
        ...
        Public Shared Function GetStoredIPsets(ByVal comp1 As String, ByVal comp2 As String, ByVal model As String) As List(Of InteractionParameter)

            Dim results As New List(Of InteractionParameter)

            If Not Settings.UserInteractionsDatabases Is Nothing Then
                For Each IPDBPath As String In Settings.UserInteractionsDatabases
                    Dim Interactions As InteractionParameter()
                    Try
                        Interactions = UserIPDB.ReadInteractions(IPDBPath, model)
                        For Each ipset As InteractionParameter In Interactions
                            If ipset.Comp1 = comp1 And ipset.Comp2 = comp2 Then
                                results.Add(ipset)
                            ElseIf ipset.Comp1 = comp2 And ipset.Comp2 = comp1 Then
                                'invert parameters
                                Dim ipset2 As InteractionParameter = ipset.Clone
    ...
    Public Class Electrolyte
        ...
        Public Sub Load()
            ...
            Using filestr As Stream = Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.electrolyte.xml")
                reader = XmlReader.Create(filestr)
                xmldoc = New XmlDocument
                xmldoc.Load(reader)
            End Using
    ...
    Public Class CoolProp
        ...
        Public Sub Load()
            ...
            Using filestr As Stream = Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.coolprop.xml")
                Using t As New StreamReader(filestr)
                    mytxt = t.ReadToEnd()
                End Using
            End Using
    ...
    Public Class ChEDL_Thermo
        ...
        Public Sub Load()
            ...
            Using filestr As Stream = Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.chedl_thermo.json")
                Using t As New StreamReader(filestr)
        ...
        Public Function Transfer() As List(Of ConstantProperties)

            Return Newtonsoft.Json.JsonConvert.DeserializeObject(Of List(Of ConstantProperties))(contents)
