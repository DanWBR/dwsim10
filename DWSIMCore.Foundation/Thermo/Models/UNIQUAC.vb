...
Namespace PropertyPackages.Auxiliary
    ...
    <System.Serializable()> Public Class UNIQUAC
        ...
        Sub New()
            ...
            Using filestr As Stream = System.Reflection.Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.uniquac.dat")
                Using t As New StreamReader(filestr)
                    uniquacipc = fh1.ReadStream(t)
                End Using
            End Using

            Using filestr As Stream = System.Reflection.Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.uniquacip.dat")
                Using t As New StreamReader(filestr)
        ...
        Function GAMMA_MR(ByVal T As Double, ByVal Vx As Double(), ByVal Vids As String(), ByVal VQ As Double(), ByVal VR As Double())
            ...
            Host.CheckAndAdd(IObj, "", "GAMMA_MR", "UNIQUAC Activity Coefficient", "UNIQUAC Activity Coefficient Calculation Routine")
