...
Imports FileHelpers
Imports DWSIMCore.Foundation.PropertyPackages.ThermoPlugs.SRK
...
Namespace PropertyPackages.Auxiliary
    ...
    <System.Serializable()> Public Class SRK
        ...
        Sub New()
            ...
            Using filestr As IO.Stream = System.Reflection.Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.srk_ip.dat")
        ...
        Function H_SRK_MIX(ByVal TIPO As String, ByVal T As Double, ByVal P As Double, ByVal Vz As Double(), ByVal VKij As Double(,), ByVal Tc As Double(), ByVal Pc As Double(), ByVal w As Double(), ByVal VMM As Double(), ByVal Hid As Double) As Double
            ...
            Host.CheckAndAdd(IObj, "", "H_SRK_MIX", "SRK EOS Enthalpy", "SRK EOS Enthalpy Calculation Routine")
