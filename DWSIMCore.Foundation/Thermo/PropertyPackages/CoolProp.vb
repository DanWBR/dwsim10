...
Namespace PropertyPackages
    ...
    <System.Serializable()> Public Class CoolPropPropertyPackage
        ...
        Private Sub SetCPDebugLevel()
            ...
            If Settings.InspectorEnabled Then
...
#Region "    DWSIM Functions"
        ...
        Public Overrides Function AUX_CPi(sub1 As String, T As Double) As Double
            ...
            Host.CheckAndAdd(IObj, "", "AUX_CPi", routinename, "", True)
            _IObj = IObj
        ...
        Public Overrides Function AUX_PVAPi(index As Integer, T As Double) As Double
            ...
            Host.CheckAndAdd(IObj, "", "AUX_PVAPi", routinename, "", True)
            _IObj = IObj
        ...
        Public Overrides Function AUX_TSATi(PVAP As Double, index As Integer) As Double
            ...
            Host.CheckAndAdd(IObj, "", "AUX_TSATi", routinename, "", True)
            _IObj = IObj
        ...
        Public Overrides Function AUX_LIQDENSi(cprop As ICompoundConstantProperties, T As Double) As Double
            ...
            Host.CheckAndAdd(IObj, "", "AUX_LIQDENSi", routinename, "", True)
            _IObj = IObj
        ...
        Public Overrides Function AUX_LIQ_Cpi(cprop As ICompoundConstantProperties, T As Double) As Double
            ...
            Host.CheckAndAdd(IObj, "", "AUX_LIQ_Cpi", routinename, "", True)
            _IObj = IObj
        ...
        Public Overrides Function AUX_CONDTG(T As Double, P As Double) As Double
            ...
            Host.CheckAndAdd(IObj, "", "AUX_CONDTG", routinename, "", True)
            _IObj = IObj
        ...
        Public Overrides Function AUX_CONDTL(T As Double, Optional phaseid As Integer = 3) As Double
            ...
            Host.CheckAndAdd(IObj, "", "AUX_CONDTL", routinename, "", True)
            _IObj = IObj
            ...
            For Each subst As ICompound In Me.CurrentMaterialStream.Phases(phaseid).Compounds.Values
                If subst.MassFraction.GetValueOrDefault() > 0.0 Then
                    If IsCompoundSupported(subst.Name) Then
                        Dim sub1 As String = subst.Name
                        Tmin = CoolProp.Props1SI(GetCoolPropName(sub1), "TMIN")
        ...
        Public Overrides Function AUX_LIQDENS(T As Double, Vx As System.Array, Optional P As Double = 0.0, Optional Pvp As Double = 0.0, Optional FORCE_EOS As Boolean = False) As Double
            ...
            Host.CheckAndAdd(IObj, "", "AUX_LIQDENS", routinename, "", True)
            _IObj = IObj
        ...
        Public Overrides Function AUX_LIQTHERMCONDi(cprop As ICompoundConstantProperties, T As Double) As Double
            ...
            Host.CheckAndAdd(IObj, "", "AUX_LIQTHERMCONDi", routinename, "", True)
            _IObj = IObj
        ...
        Public Overrides Function AUX_LIQVISCi(sub1 As String, T As Double, P As Double) As Double
            ...
            Host.CheckAndAdd(IObj, "", "AUX_LIQVISCi", routinename, "", True)
            _IObj = IObj
        ...
        Public Overrides Function AUX_SURFTi(constprop As ICompoundConstantProperties, T As Double) As Double
            ...
            Host.CheckAndAdd(IObj, "", "AUX_SURFTi", routinename, "", True)
            _IObj = IObj
        ...
        Public Overrides Function AUX_VAPTHERMCONDi(cprop As ICompoundConstantProperties, T As Double, P As Double) As Double
            ...
            Host.CheckAndAdd(IObj, "", "AUX_VAPTHERMCONDi", routinename, "", True)
            _IObj = IObj
        ...
        Public Overloads Function AUX_VAPVISCi(cprop As ICompoundConstantProperties, T As Double, P As Double) As Double

            Dim IObj As InspectorItem = Host.GetNewInspectorItem()
            Dim routinename As String = ComponentName & String.Format(" (Vapor Viscosity - {0})", cprop.Name)
            Host.CheckAndAdd(IObj, "", "AUX_VAPVISCi", routinename, "", True)
            _IObj = IObj
        ...
        Public Overrides Function AUX_VAPDENS(ByVal T As Double, ByVal P As Double) As Double
            ...
            Host.CheckAndAdd(IObj, "", "AUX_VAPDENS", routinename, "", True)
            _IObj = IObj
        ...
        Public Overrides Function DW_CalcEnthalpy(ByVal Vx As System.Array, ByVal T As Double, ByVal P As Double, ByVal st As State) As Double
            ...
            Host.CheckAndAdd(IObj, "", "DW_CalcEnthalpy", routinename, "", True)
            _IObj = IObj
        ...
        Public Overrides Function DW_CalcEntropy(ByVal Vx As System.Array, ByVal T As Double, ByVal P As Double, ByVal st As State) As Double
            ...
            Host.CheckAndAdd(IObj, "", "DW_CalcEntropy", routinename, "", True)
            _IObj = IObj
        ...
        Public Overrides Function DW_CalcFugCoeff(ByVal Vx As System.Array, ByVal T As Double, ByVal P As Double, ByVal st As State) As Double()
            ...
            Host.CheckAndAdd(IObj, "", "DW_CalcFugCoeff", "Fugacity Coefficient", "Property Package Fugacity Coefficient Calculation Routine")
        ...
        Public Overrides Sub DW_CalcPhaseProps(ByVal Phase As Phase)
            ...
            Host.CheckAndAdd(IObj, "", "DW_CalcPhaseProps", ComponentName & String.Format(" (Phase Properties - {0})", [Enum].GetName(Phase.GetType, Phase)), "Property Package Phase Properties Calculation Routine")
        ...
        Public Overrides Function SupportsComponent(ByVal comp As ICompoundConstantProperties) As Boolean
...
#End Region
        ...
        Public Overrides Function AUX_Z(Vx() As Double, T As Double, P As Double, state As PhaseName) As Double
            ...
            Host.CheckAndAdd(IObj, "", "AUX_Z", "Compressibility Factor", "Compressibility Factor Calculation Routine")
