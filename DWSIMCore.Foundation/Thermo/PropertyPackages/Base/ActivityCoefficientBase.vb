...
#Region "Functions to Calculate Isolated Properties"
        ...
        Public Overrides Function AUX_VAPDENS(ByVal T As Double, ByVal P As Double) As Double
            ...
            Host.CheckAndAdd(IObj, "", "AUX_VAPDENS", "Vapor Phase Density", "Vapor Phase Density Calculation Routine")
        ...
        Public Overloads Overrides Sub DW_CalcCompPartialVolume(ByVal phase As Phase, ByVal T As Double, ByVal P As Double)
            ...
            For j As Integer = 1 To 7
                ...
                If j <> 2 Then
                    ...
                    i = 0
                    For Each subst As ICompound In Me.CurrentMaterialStream.Phases(j).Compounds.Values
        ...
        Public Overrides Function RET_VKij() As Double(,)
            ...
            i = 0
            For Each cp As ICompound In Me.CurrentMaterialStream.Phases(0).Compounds.Values
                l = 0
                For Each cp2 As ICompound In Me.CurrentMaterialStream.Phases(0).Compounds.Values
...
#Region "Main Property Routines"
        ...
        Public Overrides Function DW_CalcEnthalpy(ByVal Vx As System.Array, ByVal T As Double, ByVal P As Double, ByVal st As State) As Double
            ...
            Else
                ...
                Host.CheckAndAdd(IObj, "", "DW_CalcEnthalpy", "Enthalpy", "Property Package Enthalpy Calculation Routine")
        ...
        Public Overrides Function DW_CalcEntropy(ByVal Vx As System.Array, ByVal T As Double, ByVal P As Double, ByVal st As State) As Double
            ...
            Else
                ...
                Host.CheckAndAdd(IObj, "", "DW_CalcEntropy", "Entropy", "Entropy Calculation Routine")
