...
Namespace PropertyPackages
    ...
    <System.Serializable()> Public Class PengRobinson1978PropertyPackage
...
#Region "    DWSIM Functions"
        ...
        Private Function AUX_Ci(cprop As ICompoundConstantProperties) As Double
...
#End Region
        ...
        Public Overrides Function DW_CalcEnthalpy(ByVal Vx As System.Array, ByVal T As Double, ByVal P As Double, ByVal st As State) As Double
            ...
            Else
                ...
                Host.CheckAndAdd(IObj, "", "DW_CalcEnthalpy", "Peng-Robinson EOS Enthalpy", "Property Package Enthalpy Calculation Routine")
        ...
        Public Overrides Function DW_CalcEntropy(ByVal Vx As System.Array, ByVal T As Double, ByVal P As Double, ByVal st As State) As Double
            ...
            Else
                ...
                Host.CheckAndAdd(IObj, "", "DW_CalcEntropy", "Peng-Robinson EOS Entropy", "Property Package Entropy Calculation Routine")
            ...
            Select Case phase
                Case Phase.Liquid
                    ...
                    Else
                        ...
                        For Each subst As ICompound In Me.CurrentMaterialStream.Phases(key).Compounds.Values
        ...
        Public Overrides Function DW_CalcFugCoeff(ByVal Vx As System.Array, ByVal T As Double, ByVal P As Double, ByVal st As State) As Double()
            ...
            Host.CheckAndAdd(IObj, "", "DW_CalcFugCoeff", "Peng-Robinson EOS Fugacity Coefficient", "Property Package Fugacity Coefficient Calculation Routine")
