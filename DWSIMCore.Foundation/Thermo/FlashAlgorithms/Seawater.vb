...
Imports DWSIMCore.Foundation.MathEx.Common
...
Namespace PropertyPackages.Auxiliary.FlashAlgorithms
    ...
    <System.Serializable()> Public Class Seawater
        ...
        Public Overrides ReadOnly Property AlgoType As Enums.FlashMethod
            Get
                Return Enums.FlashMethod.SeaWater
            End Get
        End Property
        ...
        Public Function Flash_PT_Internal(ByVal include_vapor As Boolean, ByVal Vz As Double(), ByVal P As Double, ByVal T As Double, ByVal PP As PropertyPackages.PropertyPackage, Optional ByVal ReuseKI As Boolean = False, Optional ByVal PrevKi As Double() = Nothing) As Object
            ...
            Dim wid As Integer = CompoundProperties.IndexOf((From c As ICompoundConstantProperties In CompoundProperties Select c Where c.CAS_Number = "7732-18-5").SingleOrDefault)
            ...
            Do
                ...
                If Double.IsNaN(S) Then Throw New Exception(("PP_FlashTPSolidFracError"))
                If ecount > maxit_e Then Throw New Exception(("PP_FlashMaxIt2"))
