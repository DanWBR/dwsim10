...
Public Class ChemSepIPDReader
    ...
    Sub New()
        ...
        Using filestr As IO.Stream = System.Reflection.Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.CAS_IDs.txt")
    ...
    Public Function ReadNRTLIPD() As List(Of PropertyPackages.Auxiliary.NRTL_IPData)
        ...
        Using filestr As IO.Stream = System.Reflection.Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.nrtl.ipd")
            Using t As New IO.StreamReader(filestr)
                Dim i As Integer = 0
                While Not t.EndOfStream
                    Dim line = t.ReadLine()
    ...
    Public Function ReadUNIQUACIPD() As List(Of UNIQUAC_IPData)
        ...
        Using filestr As IO.Stream = System.Reflection.Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.uniquac.ipd")
            Using t As New IO.StreamReader(filestr)
                Dim i As Integer = 0
                While Not t.EndOfStream
                    Dim line = t.ReadLine()
