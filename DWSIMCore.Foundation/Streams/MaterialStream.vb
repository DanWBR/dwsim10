...
Namespace Streams
    ...
    <System.Serializable()> Public Class MaterialStream
        ...
        <System.NonSerialized()> Private _flowsheet As IFlowsheet
        ...
        Public Overrides Function SaveData() As System.Collections.Generic.List(Of System.Xml.Linq.XElement)
            ...
            With elements
                ...
                For Each kvp As KeyValuePair(Of Integer, IPhase) In m_Phases
                    .Item(.Count - 1).Add(New XElement("Phase", {New XElement("ID", kvp.Key), DirectCast(kvp.Value, ICustomXMLSerialization).SaveData().ToArray()}))
                Next
            End With
...
#Region "    DWSIM Specific"
        ...
        Public Overloads Sub Calculate(equilibrium As Boolean, properties As Boolean)
            ...
            Host.CheckAndAdd(IObj, "", "Calculate", If(GraphicObject IsNot Nothing, GraphicObject.Tag, "Temporary Object") & " (" & GetDisplayName() & ")", "Material Stream Calculation Routine", True)
        ...
        ''' <param name="Vx"></param>
        ''' <remarks></remarks>
        Public Sub SetOverallComposition(ByVal Vx As Array) Implements IMaterialStream.SetOverallComposition
        ...
        Public Sub SetPhaseComposition1(ByVal Vx As Array, ByVal phase As Integer) Implements IMaterialStream.SetPhaseComposition
...
#Region "    CAPE-OPEN 1.1 Thermo & Properties"
        ...
        Public Sub ClearAllProps() Implements ICapeThermoMaterial.ClearAllProps, IMaterialStream.ClearAllProps
            Me.PropertyPackage.CurrentMaterialStream = Me
            Me.PropertyPackage.DW_ZerarPhaseProps(PropertyPackages.Phase.Vapor)
            Me.PropertyPackage.DW_ZerarPhaseProps(PropertyPackages.Phase.Liquid)
            Me.PropertyPackage.DW_ZerarPhaseProps(PropertyPackages.Phase.Liquid1)
        ...
        ''' <param name="composition">Composition (mole fractions)</param>
        ''' <remarks>This method is provided to make it easier for developers to make efficient use of the CAPEOPEN
        '''  It returns the most frequently requested information from a Material
...
#End Region
        ...
        Public Overrides Function GetIconBitmap() As Object
            Using imgstream As IO.Stream = System.Reflection.Assembly.GetAssembly(Me.GetType).GetManifestResourceStream("DWSIMCore.Foundation.stream_mat_32.png")
