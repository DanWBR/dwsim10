...
Namespace FlowsheetObjects
    ...
    <System.Serializable()> <ComVisible(True)> Public MustInherit Class BaseClass
        ...
        Implements ICloneable, IDisposable, ICustomXMLSerialization

        Implements ISimulationObject, IProductInformation

        Public Const ClassId As String = ""

        <System.NonSerialized()> Protected Friend m_flowsheet As IFlowsheet
...
#Region "    ISimulationObject"
        ...
        Public Property Calculated As Boolean = False Implements ISimulationObject.Calculated

        Public Property DebugMode As Boolean = False Implements ISimulationObject.DebugMode

        <Xml.Serialization.XmlIgnore> Public Property DebugText As String = "" Implements ISimulationObject.DebugText

        Public Property LastUpdated As New Date Implements ISimulationObject.LastUpdated
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        <Xml.Serialization.XmlIgnore()> Public Overridable ReadOnly Property Phases() As Dictionary(Of Integer, IPhase)
            Get
                Throw New NotImplementedException
            End Get
        End Property
        ...
        ''' </summary>
        ''' <remarks></remarks>
        Public Overridable Sub Validate() Implements ISimulationObject.Validate

            Dim vForm As IFlowsheet = FlowSheet
            Dim vCon As IConnectionPoint
        ...
        Public Overridable Function GetDebugReport() As String Implements ISimulationObject.GetDebugReport
            Return "Error - function not implemented"
        End Function

        Public Sub AppendDebugLine(text As String) Implements ISimulationObject.AppendDebugLine
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Property ErrorMessage() As String Implements ISimulationObject.ErrorMessage
        ...
        ''' <remarks></remarks>
        Public Sub CheckSpec(val As Double, onlypositive As Boolean, paramname As String) Implements ISimulationObject.CheckSpec
        ...
        Public Property Annotation() As String = "" Implements ISimulationObject.Annotation
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Property IsAdjustAttached() As Boolean = False Implements ISimulationObject.IsAdjustAttached
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Property AttachedAdjustId() As String = "" Implements ISimulationObject.AttachedAdjustId
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Property AdjustVarType() As Enums.AdjustVarType Implements ISimulationObject.AdjustVarType
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Property IsSpecAttached() As Boolean = False Implements ISimulationObject.IsSpecAttached
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Property AttachedSpecId() As String = "" Implements ISimulationObject.AttachedSpecId
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Property SpecVarType() As Enums.SpecVarType Implements ISimulationObject.SpecVarType
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        <Xml.Serialization.XmlIgnore> Public Property GraphicObject() As IGraphicObject Implements ISimulationObject.GraphicObject
        ...
        Public Overridable Function GetProperties(proptype As PropertyType) As String() Implements ISimulationObject.GetProperties
        ...
        Public Overridable Function GetPropertyUnit(prop As String, Optional su As IUnitsOfMeasure = Nothing) As String Implements ISimulationObject.GetPropertyUnit
        ...
        Public Overridable Function GetPropertyValue(prop As String, Optional su As IUnitsOfMeasure = Nothing) As Object Implements ISimulationObject.GetPropertyValue
        ...
        Public Overridable Function SetPropertyValue(prop As String, propval As Object, Optional su As IUnitsOfMeasure = Nothing) As Boolean Implements ISimulationObject.SetPropertyValue
...
#Region "    Extras"
        ...
        Public Sub CopyDataToClipboard(su As SystemsOfUnits.Units, nf As String)
            ...
            baseobj = Me
            properties = baseobj.GetProperties(Enums.PropertyType.ALL)
            ...
            If objtype = ObjectType.MaterialStream Then
                ...
                For Each subst As ICompound In CType(Me, IMaterialStream).Phases(0).Compounds.Values
                ...
                For Each subst As ICompound In CType(Me, IMaterialStream).Phases(2).Compounds.Values
                    DT.Rows.Add(New String() {Me.FlowSheet.GetTranslatedString(subst.Name), Format(subst.MoleFraction.GetValueOrDefault, nf), ""})
                Next
                ...
                For Each subst As ICompound In CType(Me, IMaterialStream).Phases(1).Compounds.Values
                    DT.Rows.Add(New String() {Me.FlowSheet.GetTranslatedString(subst.Name), Format(subst.MoleFraction.GetValueOrDefault, nf), ""})
                Next
                ...
                Next
                DT.Rows.Add(New String() {Me.FlowSheet.GetTranslatedString("FraomolarnaPhaseLquid"), "", ""})
                For Each subst As ICompound In CType(Me, IMaterialStream).Phases(3).Compounds.Values
                    DT.Rows.Add(New String() {Me.FlowSheet.GetTranslatedString(subst.Name), Format(subst.MoleFraction.GetValueOrDefault, nf), ""})
                Next
                ...
                Next
                DT.Rows.Add(New String() {Me.FlowSheet.GetTranslatedString("FraomolarnaPhaseLquid"), "", ""})
                For Each subst As ICompound In CType(Me, IMaterialStream).Phases(4).Compounds.Values
                    DT.Rows.Add(New String() {Me.FlowSheet.GetTranslatedString(subst.Name), Format(subst.MoleFraction.GetValueOrDefault, nf), ""})
                Next
                ...
                Next
                DT.Rows.Add(New String() {Me.FlowSheet.GetTranslatedString("FraomolarnaPhaseLquid"), "", ""})
                For Each subst As ICompound In CType(Me, IMaterialStream).Phases(6).Compounds.Values
                    DT.Rows.Add(New String() {Me.FlowSheet.GetTranslatedString(subst.Name), Format(subst.MoleFraction.GetValueOrDefault, nf), ""})
                Next
            Else
        ...
        ''' <remarks></remarks>
        Public Sub SetFlowsheet(ByVal flowsheet As Object) Implements ISimulationObject.SetFlowsheet
