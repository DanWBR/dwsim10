...
#Region "Constructors"
        ...
        Public Sub New()
            Me.ObjectType = Enums.GraphicObjects.ObjectType.DistillationColumn
...
#End Region
        ...
        Private Sub DrawGP(canvas As SKCanvas, myPen As SKPaint)
            ...
            If myPen.IsStroke Then
                ...
                If DirectCast(Owner, Object).CondenserType = 0 Then
                    'total
                    canvas.DrawLine((X + 0.6 * 1.25 * Width), (Y + 0.3 * Height), (X + Width), (Y + 0.3 * Height), myPen)
                ElseIf DirectCast(Owner, Object).CondenserType = 1 Then
                    'partial
