...
#Region "Constructors"
        ...
        Public Sub New()
            Me.ObjectType = Enums.GraphicObjects.ObjectType.CapeOpenUO
...
#End Region
        ...
        Public Overrides Sub Draw(ByVal g As Object)
            ...
            If Owner IsNot Nothing AndAlso DirectCast(Owner, Object).UseEmbeddedImage = True AndAlso DirectCast(Owner, Object).EmbeddedImageData <> "" Then

                Dim p As New SKPaint
                With p
                    p.IsAntialias = Settings.DrawingAntiAlias
                    p.FilterQuality = SKFilterQuality.High
                End With

                Using image As SKImage = EmbeddedImageGraphic.Base64ToImage(DirectCast(Owner, Object).EmbeddedImageData)
