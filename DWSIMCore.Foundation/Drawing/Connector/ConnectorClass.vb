...
Imports SkiaSharp
Imports s = DWSIMCore.Foundation.Settings
...
Namespace GraphicObjects
    ...
    Public Class ConnectionPoint
        ...
        Public Property AttachedConnector As IConnectorGraphicObject = Nothing Implements IConnectionPoint.AttachedConnector

        Public Property ConnectorName As String = "" Implements IConnectionPoint.ConnectorName

        Public Property Direction As Enums.GraphicObjects.ConDir = Enums.GraphicObjects.ConDir.Right Implements IConnectionPoint.Direction
        ...
        Public Property Type As Enums.GraphicObjects.ConType Implements IConnectionPoint.Type

        Public Property X As Integer = 0 Implements IConnectionPoint.X

        Public Property Y As Integer = 0 Implements IConnectionPoint.Y
...
#End Region
            ...
            Select Case DrawMode
                Case 0
                    ...
                    With myPen
                        ...
                        .IsAntialias = Settings.DrawingAntiAlias
                    ...
                    If Not Straight Then
                        ...
                        If Not Settings.DarkMode Then canvas.DrawPath(path, myPen2)
        ...
        Public Property AttachedFrom As IGraphicObject = Nothing Implements IConnectorGraphicObject.AttachedFrom

        Public Property AttachedFromConnectorIndex As Integer = -1 Implements IConnectorGraphicObject.AttachedFromConnectorIndex

        Public Property AttachedFromEnergy As Boolean = False Implements IConnectorGraphicObject.AttachedFromEnergy

        Public Property AttachedTo As IGraphicObject = Nothing Implements IConnectorGraphicObject.AttachedTo

        Public Property AttachedToConnectorIndex As Integer = -1 Implements IConnectorGraphicObject.AttachedToConnectorIndex

        Public Property AttachedToEnergy As Boolean = False Implements IConnectorGraphicObject.AttachedToEnergy

        Public Property AttachedToOutput As Boolean = False Implements IConnectorGraphicObject.AttachedToOutput

        Public Property AttachedFromInput As Boolean = False Implements IConnectorGraphicObject.AttachedFromInput
