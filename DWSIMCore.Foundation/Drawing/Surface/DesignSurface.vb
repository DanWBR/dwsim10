...
#End Region
    ...
    Private _FloatingTable As FloatingTableGraphic
    ...
    Public Sub UpdateCanvas(DrawingCanvas As SKCanvas)
        ...
        If DrawingObjects.Count = 0 AndAlso Not Settings.OldUI Then
    ...
    Private Sub DrawPropertyListBlock(canvas As SKCanvas, gobj As GraphicObject)
        ...
        If Not gobj.Owner Is Nothing Then
            ...
            If gobj.Owner.GetFlowsheet IsNot Nothing Then
                ...
                If gobj.Owner.GraphicObject.ObjectType = Enums.GraphicObjects.ObjectType.CapeOpenUO Then props = gobj.Owner.GetProperties(Enums.PropertyType.ALL).ToList
