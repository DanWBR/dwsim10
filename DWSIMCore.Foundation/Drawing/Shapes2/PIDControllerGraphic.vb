...
#Region "Constructors"
        ...
        Public Sub New()
            Me.ObjectType = Enums.GraphicObjects.ObjectType.Controller_PID
...
#End Region
        ...
        Public Overrides Sub Draw(ByVal g As Object)
            ...
            If Owner IsNot Nothing Then
                Dim SimObject As Object = DirectCast(Owner, IAdjust)
                Dim SimObject2 = DirectCast(Owner, ISimulationObject)

                If SimObject2.GetFlowsheet().SimulationObjects.ContainsKey(SimObject.ManipulatedObjectData.ID) Then
                    SimObject.ManipulatedObject = DirectCast(SimObject, ISimulationObject).GetFlowsheet().SimulationObjects(SimObject.ManipulatedObjectData.ID)
            ...
            Using p As New SKPaint With {.IsAntialias = Settings.DrawingAntiAlias, .FilterQuality = SKFilterQuality.High}
