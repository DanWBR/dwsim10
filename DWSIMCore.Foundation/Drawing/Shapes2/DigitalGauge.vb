...
#Region "Constructors"
        ...
        Public Sub New()
            ...
            Me.ObjectType = Enums.GraphicObjects.ObjectType.DigitalGauge
...
#End Region
        ...
        Public Overrides Sub Draw(ByVal g As Object)
            ...
            If Not SelectedObject Is Nothing Then
                Try
                    currentvalue = SystemsOfUnits.Converter.ConvertFromSI(owneri.SelectedPropertyUnits, SelectedObject.GetPropertyValue(owneri.SelectedProperty))
            ...
            If GraphicsSurface.BackgroundColor <> SKColors.White Then
