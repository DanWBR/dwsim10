...
#End Region
        ...
        Public Overrides Sub Draw(ByVal g As Object)
            ...
            Dim sf = Settings.UIScalingFactor

            Dim canvas As SKCanvas = DirectCast(g, SKCanvas)

            FontSize = 12.0

            FontSize *= Settings.DpiScale * sf

            Dim zoom As Single = AdditionalInfo

            If zoom = 0.0 Then Exit Sub

            Padding = 4.0 / zoom * Settings.DpiScale * sf
            ...
            If DrawMode = 0 Then
                ...
                With tpaint
                    ...
                    .Color = If(Settings.DarkMode, SKColors.WhiteSmoke, SKColors.SteelBlue)
                    .IsStroke = False
            ...
            If Not Me.Owner Is Nothing Then
                ...
                If Me.Owner.GetFlowsheet IsNot Nothing Then
                    ...
                    If Owner.GraphicObject.ObjectType = Enums.GraphicObjects.ObjectType.CapeOpenUO Or
                        ...
                        props = Owner.GetProperties(Enums.PropertyType.ALL).ToList()
                    End If
                    ...
                    Else
                        ...
                        Dim MSObj = DirectCast(Me.Owner, IMaterialStream)
