...
#Region "Constructors"
        ...
        Public Sub New()
            MyBase.New()
            Me.ObjectType = Enums.GraphicObjects.ObjectType.GO_Button
        End Sub
        ...
        Public Sub Run()
            ...
            If SelectedScript <> "" Then
                ...
                Catch ex As Exception
                    Flowsheet.ShowMessage(String.Format("Error running script '{0}': {1}", SelectedScript, ex.Message), IFlowsheet.MessageType.GeneralError)
                End Try
            End If
