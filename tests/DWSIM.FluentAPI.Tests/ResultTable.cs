...
{
    /// <summary>
    /// Accumulates expected/calculated comparisons for a single sample case, prints a
    ...
    internal sealed class ResultTable
    {
        ...
        public void PrintAndThrowIfFailed()
        {
            ...
            const string header = "{0,-40} {1,16} {2,14} {3,10} {4,10} {5,-6} {6,6}";
            ...
            foreach (var r in _rows)
            {
                ...
                if (r.IsRange)
                {
                    ...
                    errPct = 0;
                    Console.WriteLine(string.Format("{0,-40} {1,16} {2,14:0.######} {3,10} {4,10} {5,-6} {6,6}",
