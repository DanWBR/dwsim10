...
#Region "Constructors"
        ...
        Public Sub New()
            ...
            EmbeddedResourcePhotoName = "cstr_photo.png"
        End Sub
...
#End Region
        ...
        Public Overrides Sub CreateConnectors(InCount As Integer, OutCount As Integer)
            ...
            myIC3.Position = New Point(X + 0.875 * Width, Y + 0.7 * Height)
            ...
            myOC3.Position = New Point(X + 0.875 * Width, Y + 0.9 * Height)
            ...
            With InputConnectors
                ...
                If .Count >= 3 Then
                    ...
                    .Item(2).Position = New Point(X + 0.875 * Width, Y + 0.7 * Height)
                ElseIf .Count = 2 Then
                    If DrawMode = 2 Then
                        .Item(0).Position = New Point(X + 0.05 * Width, Y + 0.1 * Height)
                    Else
            ...
            With OutputConnectors
                ...
                If .Count >= 3 Then
                    ...
                    .Item(2).Position = New Point(X + 0.875 * Width, Y + 0.9 * Height)
                ElseIf .Count = 2 Then
                    If DrawMode = 2 Then
                        .Item(0).Position = New Point(X + Width, Y + 0.7825 * Height)
                    Else
                ...
                .Item(2).ConnectorName = "Utility Fluid Outlet (Optional)"
