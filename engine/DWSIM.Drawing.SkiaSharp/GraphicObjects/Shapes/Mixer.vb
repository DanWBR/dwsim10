...
#Region "Constructors"
        ...
        Public Sub New()
            ...
            EmbeddedResourcePhotoName = "mixer_photo.png"
        End Sub
            ...
            With InputConnectors
                ...
                If .Count <> 0 Then
                    ...
                    If DrawMode = 2 Then
                        ...
                        .Item(0).Position = New Point(X + 0.125 * Width, Y + 0.4 * Height)
                        .Item(1).Position = New Point(X + 0.32 * Width, Y + 0.4 * Height)
                        .Item(2).Position = New Point(X + 0.5 * Width, Y + 0.4 * Height)
                        .Item(3).Position = New Point(X + 0.125 * Width, Y + 0.6 * Height)
                        .Item(4).Position = New Point(X + 0.32 * Width, Y + 0.6 * Height)
                        .Item(5).Position = New Point(X + 0.5 * Width, Y + 0.6 * Height)

                        .Item(0).Direction = ConDir.Down
                        .Item(1).Direction = ConDir.Down
                        .Item(2).Direction = ConDir.Down
                        .Item(3).Direction = ConDir.Up
                        .Item(4).Direction = ConDir.Up
                        .Item(5).Direction = ConDir.Up
                    ...
                    Else
                        ...
                        .Item(3).Direction = ConDir.Right
                        .Item(4).Direction = ConDir.Right
                        .Item(5).Direction = ConDir.Right
