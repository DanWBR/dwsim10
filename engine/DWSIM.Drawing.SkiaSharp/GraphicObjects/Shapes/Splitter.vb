...
#Region "Constructors"
        ...
        Public Sub New()
            ...
            EmbeddedResourcePhotoName = "splitter_photo.png"
        End Sub
...
#End Region
        ...
        Public Overrides Sub CreateConnectors(InCount As Integer, OutCount As Integer)
            ...
            With InputConnectors
                ...
                If .Count <> 0 Then
                    If DrawMode = 2 Then
                        .Item(0).Position = New Point(X + 0.5 * Width, Y + 0.5 * Height)
                    Else
            ...
            With OutputConnectors
                ...
                If .Count <> 0 Then
                    If DrawMode = 2 Then
                        .Item(0).Position = New Point(X + 0.9 * Width, Y + 0.25 * Height)
                        .Item(1).Position = New Point(X + 0.9 * Width, Y + 0.5 * Height)
                        .Item(2).Position = New Point(X + 0.9 * Width, Y + 0.75 * Height)
                    Else
