...
#Region "Constructors"
        ...
        Public Sub New()
            ...
            EmbeddedResourcePhotoName = "rigorous_column_photo.png"
        End Sub
...
#End Region
        ...
        Public Overrides Sub Draw(ByVal g As Object)
            ...
            Using myPen As New SKPaint()
                ...
                Dim IsAbsorber As Boolean = False

                IsAbsorber = Owner?.RefluxedAbsorber And Owner?.ReboiledAbsorber

                If Not IsAbsorber Then
                ...
                Else
                    ...
                    Select Case DrawMode
                        ...
                        Case 0
                            ...
                            If ratio = 1.25 Then Width = Height * 0.3
                            Width = Height * 0.3
                            ...
                            Using gradPen As New SKPaint()
                                ...
                                canvas.DrawRoundRect(New SKRect(X + 0.05 * 1.25 * Width, Y + 0.1 * Height, X + 0.05 * 1.25 * Width + 0.6 * 1.25 * Width, Y + 0.1 * Height + 0.8 * Height), 10, 10, gradPen)
                            End Using
                            ...
                            canvas.DrawRoundRect(New SKRect(X + (0.05) * 1.25 * Width, Y + 0.1 * Height, X + (0.05) * 1.25 * Width + 0.6 * 1.25 * Width, Y + 0.1 * Height + 0.8 * Height), 10, 10, myPen)

                            canvas.DrawPoints(SKPointMode.Polygon, New SKPoint() {New SKPoint(X + 0.45 * Width, Y + 0.1 * Height), New SKPoint(X + 0.45 * Width, Y + 0.02 * Height), New SKPoint(X + Width, Y + 0.02 * Height)}, myPen)
                            canvas.DrawPoints(SKPointMode.Polygon, New SKPoint() {New SKPoint(X + 0.45 * Width, Y + 0.9 * Height), New SKPoint(X + 0.45 * Width, Y + 0.98 * Height), New SKPoint(X + Width, Y + 0.98 * Height)}, myPen)

                            canvas.DrawLine((X + 0.05 * 1.25 * Width), (Y + 0.2 * Height), (X + 0.65 * 1.25 * Width), (Y + 0.2 * Height), myPen)
                            canvas.DrawLine((X + 0.05 * 1.25 * Width), (Y + 0.3 * Height), (X + 0.65 * 1.25 * Width), (Y + 0.3 * Height), myPen)
                            canvas.DrawLine((X + 0.05 * 1.25 * Width), (Y + 0.4 * Height), (X + 0.65 * 1.25 * Width), (Y + 0.4 * Height), myPen)
                            canvas.DrawLine((X + 0.05 * 1.25 * Width), (Y + 0.5 * Height), (X + 0.65 * 1.25 * Width), (Y + 0.5 * Height), myPen)
                            canvas.DrawLine((X + 0.05 * 1.25 * Width), (Y + 0.6 * Height), (X + 0.65 * 1.25 * Width), (Y + 0.6 * Height), myPen)
                            canvas.DrawLine((X + 0.05 * 1.25 * Width), (Y + 0.7 * Height), (X + 0.65 * 1.25 * Width), (Y + 0.7 * Height), myPen)
                            canvas.DrawLine((X + 0.05 * 1.25 * Width), (Y + 0.8 * Height), (X + 0.65 * 1.25 * Width), (Y + 0.8 * Height), myPen)
