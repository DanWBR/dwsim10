...
''' <summary>
''' Provides two-phase fluid flow correlation implementations used by the pipe segment unit operation,
''' including Beggs-Brill, Lockhart-Martinelli, and Petalas-Aziz correlations.
''' </summary>
