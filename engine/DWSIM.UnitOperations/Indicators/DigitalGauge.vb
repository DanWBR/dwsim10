...
Namespace UnitOperations
    ...
    <System.Serializable()> Public Partial Class DigitalGauge
        ...
        Public Overrides Function GetPropertyValue(ByVal prop As String, Optional ByVal su As Interfaces.IUnitsOfMeasure = Nothing) As Object
            ...
            Try
                ...
                'the indicator just relays the monitored value, so report it in the requested
                'unit system, keeping it consistent with GetPropertyUnit.
                Dim currentvalue = SelectedObject.GetPropertyValue(SelectedProperty, su)
        ...
        Public Overrides Function GetPropertyUnit(ByVal prop As String, Optional ByVal su As Interfaces.IUnitsOfMeasure = Nothing) As String
            ...
            Try
                ...
                Return SelectedObject.GetPropertyUnit(SelectedProperty, su)
