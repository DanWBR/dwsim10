...
''' <summary>
''' Implements the numerical solving methods used by rigorous column separation algorithms,
''' including Bubble Point, Sum-Rates, Newton-Raphson, and Tomich TDMA methods.
''' </summary>
Namespace UnitOperations.Auxiliary.SepOps.SolvingMethods
    ...
    <System.Serializable()> Public Class Tomich
        ...
        ''' The arrays <paramref name="c"/> and <paramref name="d"/> are modified in place during the computation.
        ''' </summary>
        ''' <param name="a">Sub-diagonal coefficients (index 0 is unused).</param>
        ''' <param name="b">Main-diagonal coefficients.</param>
        ''' <param name="c">Super-diagonal coefficients (last element is unused). Modified in place.</param>
        ''' <param name="d">Right-hand side vector. Modified in place.</param>
