...
Public Interface IPropertyPackage
    ...
    Sub PopulateCrossPlatformEditor(container As Object)

    ReadOnly Property ImplementsCrossPlatformEditor As Boolean
...
Public Interface IPhaseEnvelopeOptions
    ...
    Property SolidLiquidEquilibrium As Boolean

    Property WidomLine As Boolean
