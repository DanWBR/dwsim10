...
Public Interface IExtender
    ...
    ''' <summary>The host's main window. Its type belongs to the UI framework of the host.</summary>
    ...
    ''' <summary>The menu icon, as the bytes of a PNG. Nothing when the extender has none.</summary>
    ReadOnly Property DisplayImage As Byte()
...
Public Interface IExtender6

    Sub SetFlowsheetGUI(FlowsheetGUI As Object)
