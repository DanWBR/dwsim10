...
Public Interface IDynamicsIntegrator
    ...
    Property IntegrationMethod As Enums.Dynamics.IntegrationMethod

    Property MinimumStep As TimeSpan

    Property MaximumStep As TimeSpan

    Property ErrorTolerance As Double

    Property AdaptiveStepEnabled As Boolean

    Property MaxIterations As Integer

    Property ConvergenceTolerance As Double

    Property CurrentEffectiveStep As Double
