...
''' <summary>
''' Contains utilities for generating and fitting pseudocomponent hypotheticals from petroleum assay data,
''' including Levenberg-Marquardt curve fitting routines.
''' </summary>
