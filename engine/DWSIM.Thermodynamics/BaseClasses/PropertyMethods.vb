...
''' <summary>
''' Provides property estimation methods for characterizing petroleum fractions using
''' distillation curve and bulk property correlations (Riazi-Daubert, Watson K-factor, etc.).
''' </summary>
Namespace PetroleumCharacterization.Methods
    ...
    Public Class PropertyMethods
        ...
        ''' <remarks></remarks>
        Public Shared Function AcentricFactor_LeeKesler(ByVal Tc As Double, ByVal Pc As Double, ByVal PEMM As Double)
