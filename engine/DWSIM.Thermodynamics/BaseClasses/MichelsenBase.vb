...
Namespace PropertyPackages
    ...
    <System.Serializable()> Public MustInherit Class ThermoPlug
        ...
        ''' </summary>
        ''' <param name="V">Molar volume (m³/mol).</param>
        ''' <param name="T">Temperature (K).</param>
        ''' <param name="Vx">Array of mole fractions.</param>
        ''' <param name="VKij">Binary interaction parameter matrix.</param>
        ''' <param name="VTc">Array of critical temperatures (K).</param>
        ''' <param name="VPc">Array of critical pressures (Pa).</param>
        ''' <param name="Vw">Array of acentric factors.</param>
        ''' <param name="otherargs">Optional additional arguments for the EOS.</param>
        ...
        ''' <param name="Vw">Array of acentric factors.</param>
        ''' <param name="otherargs">Optional additional arguments for the EOS.</param>
        ''' <param name="phase">Phase identifier (-1 for auto-detection).</param>
        ''' <returns>Array of ln(fugacity coefficients) for each component.</returns>
        ...
        ''' <summary>
        ''' Determines the phase type (vapor or liquid) and compressibility factor of a mixture at the given conditions.
        ''' </summary>
        ''' <param name="T">Temperature (K).</param>
        ''' <param name="P">Pressure (Pa).</param>
        ''' <param name="Vx">Array of mole fractions.</param>
        ...
        ''' <param name="Vw">Array of acentric factors.</param>
        ''' <param name="otherargs">Optional additional arguments for the EOS.</param>
        ''' <returns>Array containing the phase type string ("V" or "L") and the compressibility factor Z.</returns>
        ...
        ''' </summary>
        ''' <param name="phasetype">Phase type identifier ("V" for vapor, "L" for liquid).</param>
        ''' <param name="T">Temperature (K).</param>
        ''' <param name="P">Pressure (Pa).</param>
        ''' <param name="Vz">Array of mole fractions.</param>
        ''' <param name="VKij">Binary interaction parameter matrix.</param>
        ''' <param name="VTc">Array of critical temperatures (K).</param>
        ''' <param name="VPc">Array of critical pressures (Pa).</param>
        ''' <param name="Vw">Array of acentric factors.</param>
        ''' <param name="Hid">Ideal gas enthalpy (J/mol) used as reference.</param>
        ''' <param name="otherargs">Optional additional arguments for the EOS.</param>
        ''' <returns>Molar enthalpy (J/mol).</returns>
        ...
        ''' <param name="VPc">Array of critical pressures (Pa).</param>
        ''' <param name="Vw">Array of acentric factors.</param>
        ''' <param name="Sid">Ideal gas entropy (J/mol·K) used as reference.</param>
        ''' <param name="otherargs">Optional additional arguments for the EOS.</param>
        ''' <returns>Molar entropy (J/mol·K).</returns>
        ...
        ''' <param name="VPc">Array of critical pressures (Pa).</param>
        ''' <param name="Vw">Array of acentric factors.</param>
        ''' <param name="Gid">Ideal gas Gibbs energy (J/mol) used as reference.</param>
        ''' <param name="otherargs">Optional additional arguments for the EOS.</param>
        ''' <returns>Molar Gibbs energy (J/mol).</returns>
        ...
        ''' <param name="VPc">Array of critical pressures (Pa).</param>
        ''' <param name="Vw">Array of acentric factors.</param>
        ''' <param name="Aid">Ideal gas Helmholtz energy (J/mol) used as reference.</param>
        ''' <param name="otherargs">Optional additional arguments for the EOS.</param>
        ''' <returns>Molar Helmholtz energy (J/mol).</returns>
        ...
        ''' <param name="P">Pressure (Pa).</param>
        ''' <param name="T">Temperature (K).</param>
        ''' <param name="pp">The property package instance providing EOS parameters.</param>
        ''' <param name="eos">EOS identifier string ("PR", "PR78", or "SRK").</param>
        ''' <param name="cp">Molar heat capacity at constant pressure (J/mol·K).</param>
        ''' <param name="VMM">Molar mass of the mixture (kg/mol).</param>
        ''' <returns>Joule-Thomson coefficient (K/Pa).</returns>
        ...
        ''' <param name="pp">The property package instance providing EOS parameters.</param>
        ''' <param name="eos">EOS identifier string ("PR", "PR78", or "SRK").</param>
        ''' <returns>Isothermal compressibility (1/Pa).</returns>
...
#Region "        Properties"
        ...
        ''' </summary>
        ''' <returns>The <see cref="ThermoPlug"/> instance associated with this flash object.</returns>
        ...
        ''' <summary>
        ''' Gets or sets the flash algorithm type to use for phase stability and split calculations ("VL" or "LL").
        ''' </summary>
        ...
        ''' <summary>
        ''' Gets or sets the fallback flash algorithm type used when the primary Michelsen stability test fails.
        ''' </summary>
        ...
        ''' <summary>
        ''' Gets or sets the convergence tolerance used by the iterative flash and bubble/dew point algorithms.
        ''' </summary>
        ...
        ''' <summary>
        ''' Gets or sets the maximum number of inner (composition update) iterations allowed per flash calculation.
        ''' </summary>
        ...
        ''' <summary>
        ''' Gets or sets the maximum number of outer (K-value update) iterations allowed per flash calculation.
        ''' </summary>
        ...
        ''' <summary>
        ''' Gets or sets the zero-based index of the key component used in three-phase (VLL) flash calculations.
        ''' </summary>
...
#Region "        Main Flash and Auxiliary Functions"
        ...
        ''' </summary>
        ''' <param name="spec1">First flash specification (e.g., FlashSpec.T or FlashSpec.P).</param>
        ''' <param name="spec2">Second flash specification (e.g., FlashSpec.P, FlashSpec.H, FlashSpec.S, or FlashSpec.VAP).</param>
        ''' <param name="val1">Value for the first specification (in SI units).</param>
        ''' <param name="val2">Value for the second specification (in SI units).</param>
        ''' <param name="Vz">Array of overall mole fractions.</param>
        ''' <param name="VKij">Binary interaction parameter matrix.</param>
        ''' <param name="VTc">Array of critical temperatures (K).</param>
        ''' <param name="VPc">Array of critical pressures (Pa).</param>
        ''' <param name="Vw">Array of acentric factors.</param>
        ''' <param name="FirstEstimate">Optional first estimate for the unknown variable (0 for automatic).</param>
        ''' <param name="otherargs">Optional additional arguments passed to the EOS.</param>
        ''' <returns>Array containing the calculated temperature, pressure, and phase split results.</returns>
...
#Region "        Bubble/Dew Point Functions"
        ...
        ''' <param name="T">Temperature (K).</param>
        ''' <param name="P">Pressure (Pa).</param>
        ''' <param name="Vx">Array of liquid-phase mole fractions.</param>
        ''' <param name="Vy">Array of vapor-phase mole fractions.</param>
        ''' <param name="VKij">Binary interaction parameter matrix.</param>
        ''' <param name="VTc">Array of critical temperatures (K).</param>
        ''' <param name="VPc">Array of critical pressures (Pa).</param>
        ''' <param name="Vw">Array of acentric factors.</param>
        ''' <param name="otherargs">Optional additional arguments for the EOS.</param>
        ''' <returns>Array of dK/dT values for each component.</returns>
...
Final:
        ...
        ''' <param name="Vw">Array of acentric factors.</param>
        ''' <param name="otherargs">Optional additional arguments for the EOS.</param>
        ''' <returns>Array of dK/dP values for each component.</returns>
...
Final:
        ...
        ''' </summary>
        ''' <param name="T">Temperature (K) at which to find the dew pressure.</param>
        ''' <param name="Vy">Array of vapor-phase (overall) mole fractions.</param>
        ''' <param name="VKij">Binary interaction parameter matrix.</param>
        ''' <param name="VTc">Array of critical temperatures (K).</param>
        ''' <param name="VPc">Array of critical pressures (Pa).</param>
        ''' <param name="Vw">Array of acentric factors.</param>
        ''' <param name="KI">Array of initial K-value estimates (0 to auto-generate from Raoult's law).</param>
        ''' <param name="P">Initial pressure estimate (Pa); uses Raoult's law estimate if 0.</param>
        ''' <param name="otherargs">Optional additional arguments for the EOS.</param>
        ''' <returns>Array where index 0 is the dew point pressure (Pa) and indices 1..n are the converged K-values.</returns>
        ...
        ''' </summary>
        ''' <param name="T">Temperature (K) at which to find the bubble pressure.</param>
        ''' <param name="Vx">Array of liquid-phase (overall) mole fractions.</param>
        ''' <param name="VKij">Binary interaction parameter matrix.</param>
        ''' <param name="VTc">Array of critical temperatures (K).</param>
        ''' <param name="VPc">Array of critical pressures (Pa).</param>
        ''' <param name="Vw">Array of acentric factors.</param>
        ...
        ''' <param name="P">Initial pressure estimate (Pa); uses Raoult's law estimate if 0.</param>
        ''' <param name="otherargs">Optional additional arguments for the EOS.</param>
        ''' <returns>Array where index 0 is the bubble point pressure (Pa) and indices 1..n are the converged K-values.</returns>
        ...
        ''' </summary>
        ''' <param name="P">Pressure (Pa) at which to find the dew temperature.</param>
        ''' <param name="Vy">Array of vapor-phase (overall) mole fractions.</param>
        ''' <param name="VKij">Binary interaction parameter matrix.</param>
        ''' <param name="VTc">Array of critical temperatures (K).</param>
        ''' <param name="VPc">Array of critical pressures (Pa).</param>
        ''' <param name="Vw">Array of acentric factors.</param>
        ''' <param name="KI">Array of initial K-value estimates (0 to auto-generate).</param>
        ''' <param name="T">Initial temperature estimate (K); uses saturation temperature estimate if 0.</param>
        ''' <param name="otherargs">Optional additional arguments for the EOS.</param>
        ''' <returns>Array where index 0 is the dew point temperature (K) and indices 1..n are the converged K-values.</returns>
        ...
        ''' </summary>
        ''' <param name="P">Pressure (Pa) at which to find the bubble temperature.</param>
        ''' <param name="Vx">Array of liquid-phase (overall) mole fractions.</param>
        ''' <param name="VKij">Binary interaction parameter matrix.</param>
        ''' <param name="VTc">Array of critical temperatures (K).</param>
        ''' <param name="VPc">Array of critical pressures (Pa).</param>
        ...
        ''' <param name="T">Initial temperature estimate (K); uses saturation temperature estimate if 0.</param>
        ''' <param name="otherargs">Optional additional arguments for the EOS.</param>
        ''' <returns>Array where index 0 is the bubble point temperature (K) and indices 1..n are the converged K-values.</returns>
...
#Region "        Critical Point General Calculation Routines (EXPERIMENTAL)"
        ...
        ''' </summary>
        ''' <param name="jidx">Zero-based index of the component j with respect to which the derivative is taken.</param>
        ''' <param name="T">Temperature (K).</param>
        ''' <param name="V">Molar volume (m³/mol).</param>
        ''' <param name="Vz">Array of mole fractions.</param>
        ''' <param name="VKij">Binary interaction parameter matrix.</param>
        ...
        ''' <param name="Vw">Array of acentric factors.</param>
        ''' <param name="otherargs">Optional additional arguments for the EOS.</param>
        ''' <returns>Array of d(ln fi)/dn_j values for each component i.</returns>
        ...
        ''' <summary>
        ''' Calculates the second derivative of ln(fugacity coefficient) of each component i with respect to mole numbers n_j and n_k,
        ''' using a four-point central finite difference scheme applied to <see cref="dlnfug_i_dn_j"/>.
        ''' </summary>
        ''' <param name="jidx">Zero-based index of component j for the first differentiation.</param>
        ''' <param name="kidx">Zero-based index of component k for the second differentiation.</param>
        ''' <param name="T">Temperature (K).</param>
        ''' <param name="V">Molar volume (m³/mol).</param>
        ''' <param name="Vz">Array of mole fractions.</param>
        ''' <param name="VKij">Binary interaction parameter matrix.</param>
        ...
        ''' <param name="Vw">Array of acentric factors.</param>
        ''' <param name="otherargs">Optional additional arguments for the EOS.</param>
        ''' <returns>Array of d²(ln fi)/dn_j dn_k values for each component i.</returns>
        ...
        ''' <param name="VKIj">Binary interaction parameter matrix.</param>
        ''' <param name="otherargs">Optional additional arguments for the EOS.</param>
        ''' <returns>ArrayList of stable critical point candidates; each entry is an array {T (K), P (Pa), V (m³/mol)}.</returns>
...
Final2:
        ...
        ''' <param name="VTc">Array of critical temperatures (K).</param>
        ''' <param name="VPc">Array of critical pressures (Pa).</param>
        ''' <param name="VVc">Array of critical volumes (m³/mol); used for reference.</param>
        ''' <param name="Vw">Array of acentric factors.</param>
        ''' <param name="VKIj">Binary interaction parameter matrix.</param>
        ''' <param name="Vmax">Maximum molar volume for the sweep (m³/mol); auto-estimated if 0.</param>
        ''' <param name="delta">Step size parameter for the volume sweep.</param>
        ''' <param name="multipl">Multiplier applied to the EOS co-volume to estimate the maximum sweep volume.</param>
        ''' <param name="otherargs">Optional additional arguments for the EOS.</param>
        ''' <returns>ArrayList of {T (K), P (Pa)} pairs along the stability curve.</returns>
