    ...
    Public Class NestedLoopsSVLLE
        ...
        Public Overrides Function Flash_PT(Vz() As Double, P As Double, T As Double, PP As PropertyPackage, Optional ReuseKI As Boolean = False, Optional PrevKi() As Double = Nothing) As Object
            ...
            If PP.ImmiscibleLiquids.Count > 0 Then
                ...
                Dim immscheck As Object() = ProcessImmiscibleLiquids(PP, L1, L2, Vx1, Vx2)

                L1 = DirectCast(immscheck(0), Double)
                Vx1 = DirectCast(immscheck(1), Double())
                L2 = DirectCast(immscheck(2), Double)
                Vx2 = DirectCast(immscheck(3), Double())
