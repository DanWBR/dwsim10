            ...
            Try
                Select Case Flashtype
                    ...
                    Case "VLE"
                        ...
                        If Not UseIO Then
                            If FlashSettings(FlashSetting.NestedLoops_v2) Then
                                Dim nl = New NestedLoops2
                        ...
                        End If
                    Case "VLLE"
                        If FlashSettings(FlashSetting.ImmiscibleWaterOption) = True Or
                            (PP.ImmiscibleLiquids.Count = 1 AndAlso PP.ImmiscibleLiquids(0) = "Water") Then
                ...
                Select Case FSMethod
                    ...
                    Case 1 'Ideal VLE
                        ...
                        Using IPP As New RaoultPropertyPackage()
                            ...
                            Dim nl = New NestedLoops
                            nl.FlashSettings = FlashSettings
                            result = nl.Flash_PT(Vz, P, T, IPP, False, Nothing)
                ...
                Select Case FSMethod
                    ...
                    Case 1 'Ideal VLE
                        ...
                        Using IPP As New RaoultPropertyPackage()
                            ...
                            Dim nl = New NestedLoops
                            nl.FlashSettings = FlashSettings
                            result = nl.Flash_PV(Vz, P, V, Tref, IPP, ReuseKI, PrevKi)
