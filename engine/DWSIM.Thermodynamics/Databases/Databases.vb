...
''' <summary>
''' Contains classes for loading and managing compound databases, including the built-in DWSIM,
''' ChemSep, and CoolProp databases used to populate flowsheet component lists.
''' </summary>
Namespace Databases
