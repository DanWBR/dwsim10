...
''' <summary>
''' Exposes a COM-visible calculator interface that provides thermodynamic property calculations
''' and flash routines for external applications and automation clients.
''' </summary>
Namespace CalculatorInterface
    ...
    Public Class Calculator
        ...
        <Runtime.InteropServices.DispId(16)> Public Function CalcProp(
            ...
            Dim pp As PropertyPackage = PropertyPackages.PropertyPackageFactory.Create(proppack)
        ...
        <Runtime.InteropServices.DispId(21)> Public Function GetPropPackInstance(ByVal proppackname As String) As PropertyPackage
            ...
            Dim pp As PropertyPackage = PropertyPackages.PropertyPackageFactory.Create(proppackname)
