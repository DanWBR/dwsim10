...
Namespace ExcelAddIn
    ...
    Partial Public Class ExcelIntegrationNoAttr
        ...
        ''' <summary>
        ''' Shows an error the caller could not handle. The host assigns it; without one the
        ''' error goes to the console, which is where an add-in host would look for it.
        ''' </summary>
        Public Shared Property ErrorReporter As Action(Of Exception)

        Private Shared Sub ReportError(ex As Exception)

            If ErrorReporter IsNot Nothing Then
...
#Region "Information Procedures"
        ...
        Public Shared Function GetPropPackList() As Object(,)
            ...
            Dim values As Object() = PropertyPackages.PropertyPackageFactory.Names()
        ...
        Public Shared Function GetPropList(proppack As String) As Object(,)
            ...
            Dim pp As PropertyPackages.PropertyPackage = PropertyPackages.PropertyPackageFactory.Create(proppack)
...
#Region "Flash Calculation Routines, v1"
        ...
        Public Shared Function PTFlash(proppack As String, flashalg As Integer, ByVal P As Double, T As Double, compounds As Object(), molefractions As Double(), ip1 As Object, ip2 As Object, ip3 As Object, ip4 As Object, ip5 As Object, ip6 As Object, ip7 As Object, ip8 As Object) As Object(,)
            ...
            Try
                ...
                pp = PropertyPackages.PropertyPackageFactory.Create(proppack)
                SetIP(proppack, pp, compounds, ip1, ip2, ip3, ip4, ip5, ip6, ip7, ip8)
