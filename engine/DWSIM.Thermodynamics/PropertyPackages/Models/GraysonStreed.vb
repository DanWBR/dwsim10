    ...
    <System.Serializable()> Public Class GS
        ...
        Private Shared Function NuCoefficients(ByVal mw As Double) As Double()
            If Convert.ToInt32(mw) = 2 Then
                Return New Double() {1.50709, 2.74283, -0.0211, 0.00011, 0, 0.008585, 0, 0, 0, 0}
            ElseIf Convert.ToInt32(mw) = 16 Then
                Return New Double() {1.36822, -1.54831, 0, 0.02889, -0.01076, 0.10486, -0.02529, 0, 0, 0}
            Else
                Return New Double() {2.05135, -2.10889, 0, -0.19396, 0.02282, 0.08852, 0.0, -0.00872, -0.00353, 0.00203}
            End If
        End Function
