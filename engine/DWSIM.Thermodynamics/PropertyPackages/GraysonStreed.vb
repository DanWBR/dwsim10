...
Namespace PropertyPackages
    ...
    <System.Runtime.InteropServices.Guid(GraysonStreedPropertyPackage.ClassId)>
...
#Region "   Analytical Derivatives"
        ...
        ' Temperature derivatives only. This correlation is explicit in T, so the
        ' derivative is the correlation differentiated - no root to track, no
        ' iteration to unwind. The composition derivative is a different matter and
        ...
        Public Overrides Function DW_CalcdLnFugCoeffdT(ByVal Vx As Double(), ByVal T As Double, ByVal P As Double, st As State) As Double()
            ...
            Dim d = m_cs.CalcLnFugDT(T, P, Vx, RET_VMM(), RET_VVL(), RET_VCSS(), RET_VTC(), RET_VPC(), RET_VW(), RET_VCSAc(), TIPO)
        ...
        Public Overrides Function DW_CalcdKdT(ByVal Vx As Double(), ByVal Vy As Double(), ByVal T As Double, ByVal P As Double, Optional ByVal type As String = "LV") As Double()
            ...
            Dim n As Integer = Vx.Length - 1
            Dim dLdT = m_cs.CalcLnFugDT(T, P, Vx, RET_VMM(), RET_VVL(), RET_VCSS(), RET_VTC(), RET_VPC(), RET_VW(), RET_VCSAc(), "L")
            Dim dVdT = m_cs.CalcLnFugDT(T, P, Vy, RET_VMM(), RET_VVL(), RET_VCSS(), RET_VTC(), RET_VPC(), RET_VW(), RET_VCSAc(), "V")
