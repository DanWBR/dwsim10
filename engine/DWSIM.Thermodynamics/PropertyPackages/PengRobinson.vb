...
Namespace PropertyPackages
    ...
    <System.Serializable()> Public Partial Class PengRobinsonPropertyPackage
...
#Region "   Analytical Derivatives"
        ...
        Protected Overrides Function GetCubicEOSTypeForCriticalPoint() As Integer
            Return Utilities.TCP.CubicCP.EOS_PR
        End Function
        ...
        Public Overrides Function DW_CalcdLnFugCoeffdT(ByVal Vx As Double(), ByVal T As Double, ByVal P As Double, st As State) As Double()
            ...
            Dim res = ThermoPlugs.CubicEOSDerivatives.Calc(ThermoPlugs.CubicEOSDerivatives.EOS_PR, T, P, Vx, RET_VKij, RET_VTC, RET_VPC, RET_VW, phase)
        ...
        Public Overrides Function DW_CalcdKdT(ByVal Vx As Double(), ByVal Vy As Double(), ByVal T As Double, ByVal P As Double, Optional ByVal type As String = "LV") As Double()
            ...
            Dim resL = ThermoPlugs.CubicEOSDerivatives.Calc(ThermoPlugs.CubicEOSDerivatives.EOS_PR, T, P, Vx, RET_VKij, RET_VTC, RET_VPC, RET_VW, 0)
            Dim resV = ThermoPlugs.CubicEOSDerivatives.Calc(ThermoPlugs.CubicEOSDerivatives.EOS_PR, T, P, Vy, RET_VKij, RET_VTC, RET_VPC, RET_VW, 1)
