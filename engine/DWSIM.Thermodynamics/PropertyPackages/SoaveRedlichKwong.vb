...
Namespace PropertyPackages
    ...
    <System.Serializable()> Public Partial Class SRKPropertyPackage
...
#Region "   Analytical Derivatives"
        ...
        Protected Overrides Function GetCubicEOSTypeForCriticalPoint() As Integer
            Return Utilities.TCP.CubicCP.EOS_SRK
        End Function
        ...
        Public Overrides Function DW_CalcdLnFugCoeffdT(ByVal Vx As Double(), ByVal T As Double, ByVal P As Double, st As State) As Double()
            ...
            Dim res = ThermoPlugs.CubicEOSDerivatives.Calc(ThermoPlugs.CubicEOSDerivatives.EOS_SRK, T, P, Vx, RET_VKij, RET_VTC, RET_VPC, RET_VW, phase)
        ...
        Public Overrides Function DW_CalcdKdT(ByVal Vx As Double(), ByVal Vy As Double(), ByVal T As Double, ByVal P As Double, Optional ByVal type As String = "LV") As Double()
            ...
            Dim resL = ThermoPlugs.CubicEOSDerivatives.Calc(ThermoPlugs.CubicEOSDerivatives.EOS_SRK, T, P, Vx, RET_VKij, RET_VTC, RET_VPC, RET_VW, 0)
            Dim resV = ThermoPlugs.CubicEOSDerivatives.Calc(ThermoPlugs.CubicEOSDerivatives.EOS_SRK, T, P, Vy, RET_VKij, RET_VTC, RET_VPC, RET_VW, 1)
...
#End Region
        ...
        Public Function ReturnCriticalPoints() As ArrayList
            ...
            Dim cpc As New Utilities.TCP.Methods(Utilities.TCP.CubicCP.EOS_SRK)
