...
Namespace NaturalGasHydrates
    ...
    Public Class vdwP_PP
        ...
        Function OBJ_FUNC_HYD_vdwP(ByVal hydrateType As String, ByVal P As Double, ByVal T As Double, ByVal Vz As Object, ByVal Vids As Object, Optional ByVal vaporonly As Boolean = False) As Object
...
START_LOOP:
            ...
            Do
                ...
                fP = OBJ_FUNC_HYD_vdwP(hydrateType, Pinf, T, Vz, Vids, vaporonly)
                Pinf = Pinf + delta_P
                fP_inf = OBJ_FUNC_HYD_vdwP(hydrateType, Pinf, T, Vz, Vids, vaporonly)
                'If Pinf > Psup Then
            ...
            faa = OBJ_FUNC_HYD_vdwP(hydrateType, aaa, T, Vz, Vids, vaporonly)
            fbb = OBJ_FUNC_HYD_vdwP(hydrateType, bbb, T, Vz, Vids, vaporonly)
            fcc = fbb
...
START_LOOP:
            ...
            Do
                fT = OBJ_FUNC_HYD_vdwP(hydrateType, P, Tinf, Vz, Vids, vaporonly)
                Tinf = Tinf + delta_T
                fT_inf = OBJ_FUNC_HYD_vdwP(hydrateType, P, Tinf, Vz, Vids, vaporonly)
                'If Tinf > Tsup Then
            ...
            faa = OBJ_FUNC_HYD_vdwP(hydrateType, P, aaa, Vz, Vids, vaporonly)
            fbb = OBJ_FUNC_HYD_vdwP(hydrateType, P, bbb, Vz, Vids, vaporonly)
            fcc = fbb
...
STEP2:
        ...
        Function DET_HYD_vdwP(ByVal hydrateType As String, ByVal P As Double, ByVal T As Double, ByVal Vz As Object, ByVal Vids As Object, Optional ByVal vaporonly As Boolean = False) As Object
