...
Namespace NaturalGasHydrates
    ...
    Public Class KlaudaSandler
        ...
        Function Cml_vdWP(ByVal hydrateStructure As String, ByVal cage As Integer, ByVal id As Integer, ByVal T As Double)
            ...
            If hydrateStructure = "sI" And cage = 1 Then
                Rcell1 = 7.95 / 2 * 0.0000000001
                z1 = 20
            End If
            If hydrateStructure = "sI" And cage = 2 Then
                Rcell1 = 8.6 / 2 * 0.0000000001
                z1 = 24
            End If
            If hydrateStructure = "sII" And cage = 1 Then
                Rcell1 = 7.82 / 2 * 0.0000000001
                z1 = 20
            End If
            If hydrateStructure = "sII" And cage = 2 Then
        ...
        Function Cml_KS(ByVal hydrateStructure As String, ByVal cage As Integer, ByVal id As Integer, ByVal T As Double)
            ...
            If hydrateStructure = "sI" And cage = 1 Then i = 10
            If hydrateStructure = "sI" And cage = 2 Then i = 11
            If hydrateStructure = "sII" And cage = 1 Then i = 12
            If hydrateStructure = "sII" And cage = 2 Then i = 13
        ...
        Function OBJ_FUNC_HYD_KS(ByVal hydrateType As String, ByVal P As Double, ByVal T As Double, ByVal Vz As Object, ByVal Vids As Object, Optional ByVal vaporonly As Boolean = False) As Object
...
START_LOOP:
            ...
            Do
                fP = OBJ_FUNC_HYD_KS(hydrateType, Pinf, T, Vz, Vids, vaporonly)
                Pinf = Pinf + delta_P
                fP_inf = OBJ_FUNC_HYD_KS(hydrateType, Pinf, T, Vz, Vids, vaporonly)
            ...
            faa = OBJ_FUNC_HYD_KS(hydrateType, aaa, T, Vz, Vids, vaporonly)
            fbb = OBJ_FUNC_HYD_KS(hydrateType, bbb, T, Vz, Vids, vaporonly)
            fcc = fbb
...
START_LOOP:
            ...
            ' Descending search from upper temperature to avoid spurious sign changes
            ' in OBJ_FUNC at temperatures below the valid range of the reference
            ' pressure correlations (PR is undefined below ~211 K for sI / ~253 K for sII).
            Tinf = 350
            Tsup = 200
            ...
            Do
                fT = OBJ_FUNC_HYD_KS(hydrateType, P, Tinf, Vz, Vids, vaporonly)
                Tinf = Tinf + delta_T
                fT_inf = OBJ_FUNC_HYD_KS(hydrateType, P, Tinf, Vz, Vids, vaporonly)
            ...
            faa = OBJ_FUNC_HYD_KS(hydrateType, P, aaa, Vz, Vids, vaporonly)
            fbb = OBJ_FUNC_HYD_KS(hydrateType, P, bbb, Vz, Vids, vaporonly)
            fcc = fbb
...
STEP2:
        ...
        Function DET_HYD_KS(ByVal hydrateType As String, ByVal P As Double, ByVal T As Double, ByVal Vz As Object, ByVal Vids As Object, Optional ByVal vaporonly As Boolean = False) As Object
