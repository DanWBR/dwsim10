...
Namespace PropertyPackages
    <Serializable> Public Class PhaseEnvelopeOptions
        ...
        Public Property SolidLiquidEquilibrium As Boolean = False Implements IPhaseEnvelopeOptions.SolidLiquidEquilibrium

        Public Property WidomLine As Boolean = False Implements IPhaseEnvelopeOptions.WidomLine
