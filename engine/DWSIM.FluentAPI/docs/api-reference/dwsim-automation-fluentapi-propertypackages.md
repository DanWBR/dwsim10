...
True when `name` matches a Plus / DWSIMPlus property package and therefore requires [`Activate`](dwsim-automation-fluentapi-license.md) to have been called first.
