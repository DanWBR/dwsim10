...
Public Class WeatherProvider
    ...
    Private Async Function GetWeather(latitude As Double, longitude As Double) As Task(Of WeatherResult)
        ...
        Dim url = String.Format("https://dwsimwebserver.azurewebsites.net/getweather?latitude={0}&longitude={1}",
                                latitude, longitude)
        ...
        Using response = DirectCast(Await Task.Factory.FromAsync(Of WebResponse)(
            ...
            Using stream = response.GetResponseStream()
                Using reader As New StreamReader(stream, Encoding.UTF8)
                    Dim result As String = Await reader.ReadToEndAsync()
