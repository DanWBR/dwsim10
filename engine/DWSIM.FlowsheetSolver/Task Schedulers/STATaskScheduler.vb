...
''' <summary>
''' Provides custom task scheduler implementations - including STA-thread and limited-concurrency schedulers -
''' used by the DWSIM flowsheet solver for controlled parallel execution.
''' </summary>
