...
Public Class Integrator
    ...
    Public Property IntegrationMethod As Enums.Dynamics.IntegrationMethod = Enums.Dynamics.IntegrationMethod.ExplicitEuler Implements IDynamicsIntegrator.IntegrationMethod

    Public Property MinimumStep As TimeSpan = New TimeSpan(0, 0, 0, 0, 100) Implements IDynamicsIntegrator.MinimumStep

    Public Property MaximumStep As TimeSpan = New TimeSpan(0, 0, 30) Implements IDynamicsIntegrator.MaximumStep

    Public Property ErrorTolerance As Double = 0.0001 Implements IDynamicsIntegrator.ErrorTolerance

    Public Property AdaptiveStepEnabled As Boolean = False Implements IDynamicsIntegrator.AdaptiveStepEnabled

    Public Property MaxIterations As Integer = 20 Implements IDynamicsIntegrator.MaxIterations

    Public Property ConvergenceTolerance As Double = 0.000001 Implements IDynamicsIntegrator.ConvergenceTolerance

    <Xml.Serialization.XmlIgnore>
    Public Property CurrentEffectiveStep As Double = 0.0 Implements IDynamicsIntegrator.CurrentEffectiveStep
